...
FMColor::FMColor(const FMVector3& vector)
{
	r = (uint8) (vector.x * 255.0f);
	g = (uint8) (vector.y * 255.0f);
	b = (uint8) (vector.z * 255.0f);
	a = 255;
}

FMColor::FMColor(const FMVector4& vector)
{
	r = (uint8) (vector.x * 255.0f);
	g = (uint8) (vector.y * 255.0f);
	b = (uint8) (vector.z * 255.0f);
	a = (uint8) (vector.w * 255.0f);
}
