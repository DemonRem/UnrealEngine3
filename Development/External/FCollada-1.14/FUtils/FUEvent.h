...
public:
	...
	template<class Class>
	void RemoveHandler(Class* handle, void (Class::*_function)(void))
	{
...
public:
	...
	template <class Class, class _A1>
	void RemoveHandler(Class* handle, void (Class::*_function)(_A1))
	{
...
public:
	...
	void RemoveHandler(void (*_function)(_A1, _A2))
	{
		void* function = *(void**)&_function;
		typename HandlerList::iterator it;
		for (it = handlers.begin(); it != handlers.end(); ++it)
	...
	template <class Class, class _A1, class _A2>
	void RemoveHandler(Class* handle, void (Class::*_function)(_A1, _A2))
	{
		void* function = *(void**)&_function;
		typename HandlerList::iterator it;
		for (it = handlers.begin(); it != handlers.end(); ++it)
