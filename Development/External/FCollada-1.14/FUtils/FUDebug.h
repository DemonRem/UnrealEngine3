...
private:
	...
	static void FCOLLADA_EXPORT DebugOut(uint8 verbosity, const char* message, ...);
#ifdef UNICODE
	static void FCOLLADA_EXPORT DebugOut(uint8 verbosity, const fchar* message, ...); /**< See above. */
#endif // UNICODE

	/**	Outputs a string to the debug monitor.
		The formatted message is the first parameter.
		The second parameter is the variable parmeter list. */
	static void FCOLLADA_EXPORT DebugOutV(uint8 verbosity, const char* message, va_list& vars);
#ifdef UNICODE
	static void FCOLLADA_EXPORT DebugOutV(uint8 verbosity, const fchar* message, va_list& vars); /**< See above. */
#endif // UNICODE
	...
	static void FCOLLADA_EXPORT DebugOutV(uint8 verbosity, const char* filename, uint32 line, const char* message, va_list& vars);
#ifdef UNICODE
	static void FCOLLADA_EXPORT DebugOutV(uint8 verbosity, const char* filename, uint32 line, const fchar* message, va_list& vars); /**< See above. */
#endif // UNICODE
...
public:
	...
	/**	Outputs a string to the debug monitor.
		The filename and line number are the first two parameters.
		The formatted message is the third parameter. */
	static void FCOLLADA_EXPORT DebugOut(uint8 verbosity, const char* filename, uint32 line, const char* message, ...);
#ifdef UNICODE
	static void FCOLLADA_EXPORT DebugOut(uint8 verbosity, const char* filename, uint32 line, const fchar* message, ...); /**< See above. */
#endif // UNICODE
