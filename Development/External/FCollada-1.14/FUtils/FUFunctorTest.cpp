...
TESTSUITE_TEST(DirectUtilisation)
...
TESTSUITE_TEST(QueuedUsage)
	...
	vector<TIntFunctor0*>::iterator it;
	...
	vector<TIntFunctor1*>::iterator it1;
	...
	vector<TIntFunctor2*>::iterator it2;
