...
namespace FUDaeWriter
{
	...
	inline xmlNode* AddSourceTangent(xmlNode* parent, const string& id, const FMVector2List& values) { return AddSourceTangent(parent, id.c_str(), values); } /**< See above. */
	...
	inline xmlNode* AddSourcePosition(xmlNode* parent, const string& id, const FMVector2List& values, float lengthFactor=1.0f) { return AddSourcePosition(parent, id.c_str(), values, lengthFactor); } /**< See above. */
	...
	inline xmlNode* AddSourcePosition(xmlNode* parent, const string& id, const FMVector4List& values, float lengthFactor=1.0f) { return AddSourcePosition(parent, id.c_str(), values, lengthFactor); } /**< See above. */
	...
	FCOLLADA_EXPORT void AddNodeSid(xmlNode* node, string& subId);
#ifdef UNICODE
