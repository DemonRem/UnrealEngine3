...
public:
	...
	/** Appends the integer value, after converting it to a
		string, in hexadecimal, to the content of the builder.
	...
	template <class T> void appendHex(const T& i) { for (size_t j = 0; j < sizeof(T); ++j) appendHex(*(((uint8*)&i) + j)); } /**< See above. */
...
public:
	...
	void PrintInt32(char* output, uint32 length, int32 i) { snprintf(output, length, "%I32i", i); } 

	/** Converts an unsigned integer into the given constant-sized string.
		@param output A constant-sized string.
		@param length The size of the constant-sized string.
		@param i An unsigned integer. */
	void PrintUInt32(char* output, uint32 length, uint32 i) { snprintf(output, length, "%I32u", i); }
	void PrintUInt64(char* output, uint32 length, uint64 i) { snprintf(output, length, "%I64u", i); } /**< See above. */
...
public:
	/** Converts a signed integer into the given constant-sized string.
		...
		@param length The size of the constant-sized string.
		@param i A signed integer. */
	void PrintInt32(fchar* output, uint32 length, int32 i) { fsnprintf(output, length, FC("%I32i"), i); }

	/** Converts an unsigned integer into the given constant-sized string.
		@param output A constant-sized string.
		@param length The size of the constant-sized string.
		@param i An unsigned integer. */
	void PrintUInt32(fchar* output, uint32 length, uint32 i) { fsnprintf(output, length, FC("%I32u"), i); }

	/** Converts an unsigned integer into the given constant-sized string.
		@param output A constant-sized string.
		@param length The size of the constant-sized string.
		@param i An unsigned integer. */
	void PrintUInt64(fchar* output, uint32 length, uint64 i) { fsnprintf(output, length, FC("%I64u"), i); }
