...
typedef vector<FCDAnimationCurveTracklist> FCDAnimationCurveListList; /** A dynamically-sized array of animation curves. */
...
public:
	...
	inline const string& GetTargetPointer() const { return pointer; }
	...
	inline void SetTargetPointer(string _pointer) { pointer = _pointer; }
