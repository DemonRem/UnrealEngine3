...
public:
	...
	static FCDAnimationMultiCurve* MergeCurves(const vector<FCDAnimationCurve*>& toMerge, const FloatList& defaultValues, const StringList& defaultQualifiers = StringList());
	static FCDAnimationMultiCurve* MergeCurves(const vector<const FCDAnimationCurve*>& toMerge, const FloatList& defaultValues, const StringList& defaultQualifiers = StringList()); /**< See above. */
