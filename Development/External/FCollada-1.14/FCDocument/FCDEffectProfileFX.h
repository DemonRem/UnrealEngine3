...
public:
	...
	inline const FCDEffectParameter* FindParameterByReference(const string& reference) const { return FindParameter(reference.c_str()); } /**< See above. */
	...
	inline FCDEffectParameter* FindParameterByReference(const string& reference) { return const_cast<FCDEffectParameter*>(const_cast<const FCDEffectProfileFX*>(this)->FindParameter(reference.c_str())); } /**< See above. */
