...
struct FCDFormatHint
{
	...
	vector<optionValue> options; /**< Additional hints */
};
...
private:
	...
	string format; /**< Description of the surface format */
...
public:
	...
	/** Sets format*/
	void SetFormat(string _format) { format = _format; SetDirtyFlag(); }
	
	/** Sets type*/
	void SetType(string _type) { type = _type; SetDirtyFlag(); }
