...
public:
	...
	inline FCDEffectParameter* FindParameterByReference(const string& reference) { return const_cast<FCDEffectParameter*>(const_cast<const FCDEffectProfile*>(this)->FindParameter(reference.c_str())); } /**< See above. */
