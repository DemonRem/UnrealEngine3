...
typedef vector<FCDGeometryPolygonsInput*> FCDGeometryPolygonsInputList; /**< A dynamically-sized array of FCDGeometryPolygonsInput objects. */
typedef vector<const FCDGeometryPolygonsInput*> FCDGeometryPolygonsInputConstList; /**< A dynamically-sized array of FCDGeometryPolygonsInput objects. */
...
typedef map<FCDGeometrySource*, FCDGeometrySource*> FCDGeometrySourceCloneMap;
...
public:
	...
	virtual FUStatus LoadFromXML(xmlNode* polygonNode);
	...
	/** [INTERNAL] Creates a copy of this mesh.
		...
		@param cloneMap A match-map of the original geometry sources to the clone geometry sources.
		@return An identical copy of the polygon set. */
	virtual FCDGeometryPolygons* Clone(FCDGeometryMesh* cloneParent, const FCDGeometrySourceCloneMap& cloneMap);
