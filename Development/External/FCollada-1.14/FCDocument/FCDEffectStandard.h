...
typedef vector<FCDTexture*> FCDTextureList; /**< A dynamically-sized array of texture objects. */
...
private:
	...
	FMVector4 reflectivityColor; // Maya-specific
...
private:
	...
	FUStatus ParseColorTextureParameter(xmlNode* parameterNode, FMVector4& value, FCDTextureContainer& textureBucket);
	FUStatus ParseFloatTextureParameter(xmlNode* parameterNode, float& value, FCDTextureContainer& textureBucket);
	FUStatus ParseSimpleTextureParameter(xmlNode* parameterNode, FCDTextureContainer& textureBucket);
