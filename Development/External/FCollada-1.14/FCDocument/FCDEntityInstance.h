...
public:
	...
	/** Destructor: do not use directly.
		Instead, use the appropriate release function.
		For scene node instances: FCDSceneNode::ReleaseInstance. */
	...
	void LoadExternalEntity(FCDocument* externalDocument, string daeId);
