...
struct FCDAnimationChannelDefaultValue
{
	...
	string defaultQualifier; /**< The qualifier to use with the default value when the animation value pointer is not animated. */
...
typedef vector<FCDAnimationChannelDefaultValue> FCDAnimationChannelDefaultValueList; /**< A dynamically-szied array for animation channel default values. */
