...
public:
	...
	inline FCDEffectPassBind* FindBindingReference(const string& reference) { return FindBindingReference(reference.c_str()); } /**< See above. */
	inline const FCDEffectPassBind* FindBindingReference(const string& reference) const { return FindBindingReference(reference.c_str()); } /**< See above. */
	...
	inline FCDEffectPassBind* FindBindingSymbol(const string& symbol) { return FindBindingSymbol(symbol.c_str()); } /**< See above. */
	inline const FCDEffectPassBind* FindBindingSymbol(const string& symbol) const { return FindBindingSymbol(symbol.c_str()); } /**< See above. */
	...
	inline void SetName(const string& _name) { name = _name; SetDirtyFlag(); }
