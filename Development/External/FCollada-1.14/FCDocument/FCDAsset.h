...
typedef FUObjectContainer<FCDAssetContributor> FCDAssetContributorList;
...
public:
	...
	inline void SetUpAxis(const FMVector3& _upAxis) { upAxis = _upAxis; SetDirtyFlag(); }
	inline void SetUnitName(const fstring& _unitName) { unitName = _unitName; SetDirtyFlag(); }
	inline void SetUnitConversionFactor(float factor) { unitConversionFactor = factor; SetDirtyFlag(); }
