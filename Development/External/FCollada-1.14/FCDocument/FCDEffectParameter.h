...
typedef vector<FCDEffectParameterAnnotation*> FCDEffectParameterAnnotationList;
...
public:
	...
	void SetReference(const string& _reference) { reference = _reference; SetDirtyFlag(); } /**< See above. */
	...
	void SetSemantic(const string& _semantic) { semantic = _semantic; SetDirtyFlag(); } 
...
public:
	...
	void SetValue(const string& _value) { value = _value; SetDirtyFlag(); }
