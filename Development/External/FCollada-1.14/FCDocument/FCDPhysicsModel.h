...
public:
	...
	FCDPhysicsModelInstance* AddPhysicsModelInstance(FCDPhysicsModel* model);
	...
	const FCDPhysicsRigidBody* FindRigidBodyFromSid(const string& sid) const;
