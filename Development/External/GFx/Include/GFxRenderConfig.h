...
public:
    ...
    inline  void        SetMaxCurvePixelError(Float pixelError) { MaxCurvePixelError = G_Clamp<Float>(pixelError, 1e-6f, 1e6f); }
...
inline void GFxStateBag::SetRenderConfig(GFxRenderConfig* pri)
{
    SetState(GFxState::State_RenderConfig, pri);
}
inline GPtr<GFxRenderConfig>  GFxStateBag::GetRenderConfig() const
{
    return *(GFxRenderConfig*) GetStateAddRef(GFxState::State_RenderConfig);
}

inline void GFxStateBag::SetRenderConfig(GRenderer *prenderer, Float maxError, UInt rendererFlags)
{
...
inline GPtr<GRenderer> GFxStateBag::GetRenderer() const
{
...
inline void GFxStateBag::SetRenderStats(GFxRenderStats* prs)
{
    SetState(GFxState::State_RenderStats, prs);
}
inline GPtr<GFxRenderStats>  GFxStateBag::GetRenderStats() const
{
