...
public:
    ...
    virtual bool        FindFont(FontResult *presult,
                                 ...
                                 GFxMovieDef* puserDef, GFxStateBag *pstates, 
                                 GFxResourceWeakLib* pweakLib = NULL);
    ...
    void                LoadFontNames(GStringHash<GString>& fontnames);
};
...
inline void GFxStateBag::SetFontLib(GFxFontLib* pri)
{
    SetState(GFxState::State_FontLib, pri);
}
inline GPtr<GFxFontLib>  GFxStateBag::GetFontLib() const
{
