...
typedef struct vorbis_block_internal
{
	...
	/* initialized, must be freed; blob [PACKETBLOBS/2] points to the oggpack_buffer in the  main vorbis_block */
...
typedef struct codec_setup_info 
{
	...
	highlevel_encode_setup	hi;				/* used only by vorbisenc.c.  It's a highly redundant structure, but improves clarity of program flow. */
