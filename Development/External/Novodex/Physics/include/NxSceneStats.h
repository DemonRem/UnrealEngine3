...
//collisions:
	/**
	\brief Number of contacts present in the scene for the current simulation step. Not supported by 2.5.
	*/
	NxU32   numContacts;
	/**
	\brief Maximum number of contacts present in the scene since the scene was created. Not supported by 2.5.
	*/
	NxU32   maxContacts;
	/**
...
//solver:
	/**
	\brief The number of constraints(joints+contact) present in the current simulation step. Not supported by 2.5.
	*/
	NxU32	numAxisConstraints;
	/**
	\brief The maximum number of constraints(joints+contacts) present in the scene since creation. Not supported by 2.5.
	*/
	NxU32	maxAxisConstraints;
	/**
	\brief Number of solver bodies present in the current step(ie the number of bodies subject to constraints). Not supported by 2.5.
	*/
	NxU32	numSolverBodies;
	/**
	\brief Max number of solver bodies present in the scene since creation. Not supported by 2.5.
	*/
