...
The emitter's pose can be animated directly or attached to a dynamic actor (called the frame actor). 
When attaching an emitter to a dynamic actor, one has the option of enabling impulse transfer from 
the emitter to the actor of the shape. The impulse generated is dependent on the rate, density, 
...
/** \endcond */
	...
	*/
	...
	/**
	\brief Sets the pose of the emitter relative to the frameActor. 

	The pose is set relative to the body frame for dynamic actors or relative to the shape frame for static actors.
	...
	*/
	...
	/**
	\brief Sets the position of the emitter relative to the frameActor. 

	The pose is relative to the body frame for dynamic actors or relative to the shape frame for static actors.
	...
	*/
	...
	/**
	\brief Sets the orientation of the emitter relative to the frameActor. 
...
/** \endcond */
	...
	/**
	\brief Returns the pose of the emitter relative to the frameActor. 
	...
	*/
	...
	/**
	\brief Returns the position of the emitter relative to the frameActor. 
	...
	*/
	...
	/**
	\brief Returns the orientation of the emitter relative to the frameActor. 
	...
	*/
	...
	/**
	\brief Sets the frame actor. Can be set to NULL.

	\param[in] actor The frame actor.

	<b>Platform:</b>
	\li PC SW: No
	\li PPU  : Yes (but actors have to be animated by the user)
	\li PS3  : No
	\li XB360: No

	@see NxFluidEmitterDesc.frameActor
	*/
	virtual		void 		setFrameActor(NxActor* actor)							= 0;

	/**
	\brief Returns the frame actor. May be NULL.

	\return The frame actor.
