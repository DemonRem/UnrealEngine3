...
#define NX_SDK_VERSION_MINOR  5
#define NX_SDK_VERSION_BUGFIX 1

#define NX_SDK_VERSION_NUMBER 251

#define NX_SDK_API_REV	5	// bump this number *any* time a public interface changes in any way!!!
#define NX_SDK_DESC_REV 2   // bump this number *any* time the serialization data ever changes in any way, this includes NxParameters!!
#define NX_SDK_BRANCH   1   // no longer used.
