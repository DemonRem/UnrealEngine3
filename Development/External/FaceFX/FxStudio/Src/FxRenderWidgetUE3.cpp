...
UBOOL FFaceFXStudioViewportClient::InputKey(FViewport* Viewport, INT ControllerId, FName Key, EInputEvent Event,FLOAT AmountDepressed)
{
	// Capture the mouse if holding down a mouse button.
	Viewport->CaptureMouseInput(Viewport->KeyState(KEY_LeftMouseButton)  || 
