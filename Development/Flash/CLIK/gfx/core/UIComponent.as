...
[InspectableList("disabled", "visible", "enableInitCallback", "soundMap", "bTriggerSoundsOnEvents")]
...
// Public Properties:
	...
	/** Whether or not to trigger a sound event on every event */
	public var bTriggerSoundsOnEvents:Boolean = false;
