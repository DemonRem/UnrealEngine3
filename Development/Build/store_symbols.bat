...
@SET SYMBOL_SERVER_EXEPATH="C:\Program Files (x86)\Debugging Tools for Windows\symstore.exe"
...
%SYMBOL_SERVER_EXEPATH% add /p /g %IMAGE_LOCATION_XENON% /l /f %IMAGE_LOCATION_XENON%\*.exe /x %SYMBOL_STORE_LOCATION%\exe_xenon_index.txt /a /o
