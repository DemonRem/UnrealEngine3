...
namespace UnrealDVDLayout
{
	...
	partial class UnrealDVDLayout
	{
		...
		private void CreateInstallDesignerProject( bool Report )
		{
			if( IDPTemplateName.Length > 0 )
			{
				// Create the gp3 file by reading in the template
				PCDiscLayout = ReadXml<InstallDesignerDataSet>( IDPTemplateName );
		...
		public void SaveIDP()
		{
			...
			else
			{
				...
				if( GenericSaveFileDialog.ShowDialog() == DialogResult.OK )
				{
					...
					if( WriteXml<InstallDesignerDataSet>( GenericSaveFileDialog.FileName, PCDiscLayout, "urn:schemas-microsoft-com:InstallDesignerProject.v1" ) )
					{
		...
		public void SaveIDPISO()
		{
			...
			else
			{
				...
				if( GenericFolderBrowserDialog.ShowDialog() == DialogResult.OK )
				{
					...
					if( WriteXml<InstallDesignerDataSet>( TempIDPName, PCDiscLayout, "urn:schemas-microsoft-com:InstallDesignerProject.v1" ) )
					{
