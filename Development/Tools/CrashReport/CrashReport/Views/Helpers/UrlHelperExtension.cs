...
namespace CrashReport.Views.Helpers
{
    public static class UrlHelperExtension
    {
        ...
        public static MvcHtmlString TableHeader(this UrlHelper helper, string HeaderName, string SortTerm, CrashesViewModel Model)
        {
            ...
            var url = helper.Action( "Index", new { controller = "crashes", SortTerm = SortTerm, PreviousOrder = Model.Order, PreviousTerm = Model.Term, Page = Model.PagingInfo.CurrentPage, SearchQuery = Model.Query, DateFrom = Model.DateFrom, DateTo = Model.DateTo, UserGroup = Model.UserGroup, GameName = Model.GameName } );   
        ...
        public static MvcHtmlString CallStackSearchLink(this UrlHelper helper, string CallStack, CrashesViewModel Model)
        {
            ...
            var url = helper.Action("Index", new { controller = "crashes", SortTerm = Model.Term, SortOrder = Model.Order, SearchQuery = CallStack, DateFrom = Model.DateFrom, DateTo = Model.DateTo, UserGroup = Model.UserGroup, GameName = Model.GameName, OneQuery = true });
        ...
        public static MvcHtmlString UserGroupLink(this UrlHelper helper, string UserGroup, CrashesViewModel Model)
        {
            ...
            var url = helper.Action("Index", new { controller = "crashes", SortTerm = Model.Term, SortOrder = Model.Order, SearchQuery = Model.Query, DateFrom = Model.DateFrom, DateTo = Model.DateTo, UserGroup = UserGroup, GameName = Model.GameName });
