...
<center>
    ...
    <br />
    <asp:Label ID="ProppedAmountLabelStormXenon" runat="server" Font-Size="Large" ForeColor="DarkGreen" >
    </asp:Label>
    <br />
    <asp:Label ID="ProppedAmountLabelStormPC" runat="server" Font-Size="Large" ForeColor="DarkGreen" >
    </asp:Label>
    <br />
</center>
