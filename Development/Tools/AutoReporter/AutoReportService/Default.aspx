    ...
    <div>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="FixedChangelist" HeaderText="FixedIn" SortExpression="FixedChangelist" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DatabaseConnection %>"
            SelectCommand="SELECT [ID], [UserName], [GameName], [TimeOfCrash], [ChangelistVer], [Summary], [CrashDescription], [CallStack], [Status], [TTP], [EngineMode], [CommandLine], [FixedChangelist], [Selected] FROM [ReportData] ORDER BY [ID] DESC"></asp:SqlDataSource>
    </div>
    </form>
</body>
</html>
