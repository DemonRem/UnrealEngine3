...
namespace UnrealConsole
{
	public partial class UnrealConsoleWindow : Form, IUnrealConsole
	{
		...
		private void IDM_CRASHREPORTFILTER_DropDownOpening(object sender, EventArgs e)
		{
			...
			IDM_CRASHFILTER_RELEASEFORSHIP.Checked = ( UnrealConsoleWindow.CurrentSettings.CrashFilter & CrashReportFilter.ReleaseForShip ) == CrashReportFilter.ReleaseForShip;
		}
		...
		private void IDM_CRASHFILTER_RELEASEFORSHIP_Click(object sender, EventArgs e)
		{
			...
			{
				UnrealConsoleWindow.CurrentSettings.CrashFilter &= ~CrashReportFilter.ReleaseForShip;
			}
			else
			{
				UnrealConsoleWindow.CurrentSettings.CrashFilter |= CrashReportFilter.ReleaseForShip;
