...
namespace UnSetup
{
	...
	{
		private void SetCommonKeyValues( RegistryKey Key, string InstallLocation )
		{
		...
		public void AddUDKToARP( string InstallLocation, string DisplayName )
		{
			try
			{
				...
				if( Key != null )
				{
					...
					SetCommonKeyValues( Key, InstallLocation );
