...
namespace UnSetup
{
	public partial class Utils
	{
		...
		public void PackageRedist( bool IsRedistGamePackage )
		{
			...
			if( IsRedistGamePackage )
			{
				PackageName = "UE3RedistGame";
				WorkingFolder = "Development\\Install\\InstallFilesGame";
			}
			...
			FileStream Packaged = OpenNewPackage( "Binaries\\Windows\\" + PackageName + ".exe" );
			if( Packaged != null )
			{
				// Construct a package from all the required elements
		...
		public int DisplayEULA()
		{
			...
			AddUDKToARP( InstallFolder, DisplayName );
