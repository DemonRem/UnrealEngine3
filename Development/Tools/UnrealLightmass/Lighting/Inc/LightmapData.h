...
namespace Lightmass
{
	...
	public:
		 ...
		 */
		void Quantize(INT DebugSampleIndex, UBOOL bKeepSimpleInLinearSpace, UBOOL bUseFixedScaleForSimple, FLOAT FixedScaleForSimple);
		 ...
		 */
		void Compress(INT DebugSampleIndex, UBOOL bKeepSimpleInLinearSpace, UBOOL bUseFixedScaleForSimple, FLOAT FixedScaleForSimple);
