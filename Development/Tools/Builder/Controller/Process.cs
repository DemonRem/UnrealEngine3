...
namespace Controller
{
    public class BuildProcess
    {
        ...
        public BuildProcess( Main InParent, ScriptParser InBuilder, string InExecutable, string InCommandLine, string WorkingDirectory, bool InCaptureOutputDebugString )
        {
            Parent = InParent;
            Builder = InBuilder;
