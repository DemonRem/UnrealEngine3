...
<center>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="XX-Large"
            Height="56px" Text="Epic Build System - Trigger Build from Rift Beta branch" Width="640px" ForeColor="Blue"></asp:Label><br /><br />
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="16000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="16600" />
            </SelectParameters>
            </asp:SqlDataSource>
...
<asp:QueryStringParameter Name="DisplayDetailID" Type="Int32" DefaultValue="16000" />
</SelectParameters>
 </asp:SqlDataSource>
