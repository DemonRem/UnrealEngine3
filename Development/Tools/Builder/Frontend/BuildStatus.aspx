...
<body>
    ...
    <center>
        <asp:Label ID="Label_CISSwordPC" runat="server" Height="28px" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" ForeColor="Green">
        <br />
        </asp:Label>
    </center>
        <% Response.Write( Errors["Sword"] ); %>         
    <center>
