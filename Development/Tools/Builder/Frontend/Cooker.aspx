<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cooker.aspx.cs" Inherits="Cooker" Debug="true" %>
...
<center>
    ...
    <div>
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="2000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="2600" />
            </SelectParameters>
            </asp:SqlDataSource>
...
<asp:QueryStringParameter Name="DisplayDetailID" Type="Int32" DefaultValue="200" />
</SelectParameters>
 </asp:SqlDataSource>
