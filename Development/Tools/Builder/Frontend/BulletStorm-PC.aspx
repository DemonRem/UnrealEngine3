<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bulletstorm.aspx.cs" Inherits="Bulletstorm" Debug="true" %>
...
<center>
    ...
    <div>
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="213000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="213999" />
            </SelectParameters>
            </asp:SqlDataSource>
