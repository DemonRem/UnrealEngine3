...
#ifndef WITH_APEX
#define WITH_APEX (WITH_NOVODEX && !CONSOLE && !DEDICATED_SERVER && WITH_PHYSX_COOKING)
#endif
 ...
 */
#ifndef WITH_TTS
#if PS3 || _WIN64	//@todo win64: enable once there is a 64 bit version
#define WITH_TTS 0
#else
...
/**
 * Whether to track scene usage shader stats. Needs to be implemented on the low level platform side.
 */
#define TRACK_SCENE_SHADER_STATS 0 && !FINAL_RELEASE
