...
struct FGPPObjectInfo
{
	...
	FGPPObjectInfo( EGPPTokenType Type, UObject* Object )
	:	TokenType( Type )
	{
 ...
 */
void FGameplayProfiler::BeginTrackObject( UObject* Object, EGPPTokenType Type )
{
	FGPPObjectInfo Token(Type,Object);
	MemoryWriter << Token;
}
