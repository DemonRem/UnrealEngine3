...
event RemovedChild( UIScreenObject WidgetOwner, UIObject OldChild, optional array<UIObject> ExclusionSet )
{
	...
	if ( OldChild != None && OldChild != ScrollbarVertical && OldChild != ScrollbarHorizontal )
	{
 ...
 */
private function ScrollZoneClicked( UIScrollbar Sender, float PositionPerc, int PlayerIndex )
{
