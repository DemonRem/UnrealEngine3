...
struct native UITextStyleOverride
{
	...
	var()				EUIAlignment		ClipAlignment<ToolTip=Determines which part of the string should be clipped when it doesn't fit into the bounding region only relevant is wrap mode is Clipped or wrapped)|EditCondition=bOverrideClipAlignment>;
