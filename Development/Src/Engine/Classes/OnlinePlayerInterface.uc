 ...
 */
function bool Login(byte LocalUserNum,string LoginName,string Password);
 ...
 */
function AddAddFriendByNameCompleteDelegate(delegate<OnAddFriendByNameComplete> FriendDelegate);
 ...
 * @param FriendDelegate the delegate to use for notifications
 */
function ClearAddFriendByNameCompleteDelegate(delegate<OnAddFriendByNameComplete> FriendDelegate);
 ...
 */
function AddFriendInviteReceivedDelegate(delegate<OnFriendInviteReceived> InviteDelegate);
 ...
 * @param InviteDelegate the delegate to use for notifications
 */
function ClearFriendInviteReceivedDelegate(delegate<OnFriendInviteReceived> InviteDelegate);
 ...
 */
function AddReceivedGameInviteDelegate(delegate<OnReceivedGameInvite> ReceivedGameInviteDelegate);
 ...
 * @param ReceivedGameInviteDelegate the delegate to use for notifications
 */
function ClearReceivedGameInviteDelegate(delegate<OnFriendInviteReceived> ReceivedGameInviteDelegate);
...
/**
 * Returns the list of invites for the specified player
 *
 * @param LocalUserNum the local player wanting to join
 * @param FriendInvites the set of invites cached locally for the player
 */
function GetFriendInvites(byte LocalUserNum,out array<FriendInvite> FriendInvites);
 ...
 */
function GetFriendMessages(byte LocalUserNum,out array<FriendMessage> FriendMessages);
 ...
 */
function AddFriendMessageReceivedDelegate(delegate<OnFriendMessageReceived> MessageDelegate);
 ...
 * @param MessageDelegate the delegate to use for notifications
 */
function ClearFriendMessageReceivedDelegate(delegate<OnFriendMessageReceived> MessageDelegate);
