 ...
 */
var		protected{protected}	native	const				Map_Mirror			PersistentCollectionData{TMap< FName, TLookupMap<FString> >};

/**
 * Contains the source data for all DATATYPE_Collection data fields which have their values stored in the PersistentDataFields array.
 */
var		protected{protected}	native	const	transient	Map_Mirror			RuntimeCollectionData{TMap< FName, TLookupMap<FString> >};
 ...
 *			into the out_DataValueArray variable.
 */
native virtual final noexport function bool GetCollectionValueArray( name FieldName, out array<string> out_DataValueArray, optional bool bPersistent );
 ...
 */
native virtual final function bool SetCollectionValueArray( name FieldName, out const array<string> CollectionValues, optional bool bClearExisting=true, optional int InsertIndex=INDEX_NONE, optional bool bPersistent );
 ...
 */
native virtual final function bool InsertCollectionValue( name FieldName, out const string NewValue, optional int InsertIndex=INDEX_NONE, optional bool bPersistent, optional bool bAllowDuplicateValues );
 ...
 */
native virtual final function bool RemoveCollectionValue( name FieldName, out const string ValueToRemove, optional bool bPersistent );
 ...
 */
native virtual final function bool RemoveCollectionValueByIndex( name FieldName, int ValueIndex, optional bool bPersistent );
 ...
 */
native virtual final function bool ReplaceCollectionValue( name FieldName, out const string CurrentValue, out const string NewValue, optional bool bPersistent );
 ...
 */
native virtual final function bool ReplaceCollectionValueByIndex( name FieldName, int ValueIndex, out const string NewValue, optional bool bPersistent );
 ...
 */
native virtual final function bool ClearCollectionValueArray( name FieldName, optional bool bPersistent );
 ...
 */
native virtual final function bool GetCollectionValue( name FieldName, int ValueIndex, out string out_Value, optional bool bPersistent ) const;
 ...
 */
native virtual final function int FindCollectionValueIndex( name FieldName, out const string ValueToFind, optional bool bPersistent ) const;
