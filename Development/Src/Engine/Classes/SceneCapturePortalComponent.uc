...
/** direction relative to this Actor's Rotation that others will travel to enter the portal (added to source rotation) */
var(Capture) rotator RelativeEntryRotation;
