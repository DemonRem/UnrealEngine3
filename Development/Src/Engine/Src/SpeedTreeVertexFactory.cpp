...
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeBillboardVertexFactory, FSpeedTreeBillboardVertexFactoryShaderParameters, "SpeedTreeBillboardVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeBranchVertexFactory, FSpeedTreeVertexFactoryShaderParameters, "SpeedTreeBranchVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeFrondVertexFactory, FSpeedTreeVertexFactoryShaderParameters, "SpeedTreeFrondVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeLeafCardVertexFactory, FSpeedTreeVertexFactoryShaderParameters, "SpeedTreeLeafCardVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FSpeedTreeLeafMeshVertexFactory, FSpeedTreeVertexFactoryShaderParameters, "SpeedTreeLeafMeshVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_SPEEDTREE_5_INTEGRATION,0);
