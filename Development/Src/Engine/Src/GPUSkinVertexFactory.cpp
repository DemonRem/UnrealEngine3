	...
	virtual void Set(FShader* VertexShader,const FVertexFactory* VertexFactory,const FSceneView& View) const
	{
		...
		if(GSceneRenderTargets.PrevPerBoneMotionBlur.IsLocked())
		{
			...
			if(bLocalPerBoneMotionBlur)
			{
				...
				FLOAT InvTextureWidth = 1.0f / GSceneRenderTargets.PrevPerBoneMotionBlur.GetSizeX();
...
*/
	...
	*/
	virtual void SetMesh(FShader* VertexShader,const FMeshElement& Mesh,const FSceneView& View) const
	{
		...
		UBOOL bLocalPerBoneMotionBlur = (ShaderData.GetOldBoneData(View.FrameNumber) != 0xffffffff);
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FGPUSkinVertexFactory, FGPUSkinVertexFactoryShaderParameters, "GpuSkinVertexFactory", TRUE, FALSE, TRUE, FALSE, VER_PERBONEMOTIONBLUR, 0);
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FGPUSkinMorphVertexFactory, FGPUSkinVertexFactoryShaderParameters, "GpuSkinVertexFactory", TRUE, FALSE, TRUE, FALSE, VER_PERBONEMOTIONBLUR, 0);
...
IMPLEMENT_VERTEX_FACTORY_TYPE( FGPUSkinDecalVertexFactory, FGPUSkinDecalVertexFactoryShaderParameters, "GpuSkinVertexFactory", TRUE, FALSE, TRUE, FALSE, VER_PERBONEMOTIONBLUR, 0 );
...
/** bind gpu skin decal vertex factory to its shader file and its shader parameters */
IMPLEMENT_VERTEX_FACTORY_TYPE( FGPUSkinMorphDecalVertexFactory, FGPUSkinDecalVertexFactoryShaderParameters, "GpuSkinVertexFactory", TRUE, FALSE, TRUE, FALSE, VER_PERBONEMOTIONBLUR, 0 );
