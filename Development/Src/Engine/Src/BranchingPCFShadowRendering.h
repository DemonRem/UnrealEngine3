...
*/
	...
	*/
		...
		)
	{
		...
		{
			SceneTextureParams.Set(&View,this, SF_Point, GSceneRenderTargets.GetSceneColorRawTexture(), SceneDepthUsage_ProjectedShadows);
		}
		else
		{
...
public:
	...
	*/
	...
	{
		FBranchingPCFProjectionPixelShader< BranchingPCFPolicy >::SetParameters(View,ShadowInfo);		
...
public:
	...
	*/
	...
	{
		FBranchingPCFModProjectionPixelShader<BranchingPCFPolicy>::SetParameters(View,ShadowInfo);
