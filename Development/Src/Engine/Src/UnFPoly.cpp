...
void FPoly::Init()
{
	...
	LightmassSettings.bUseEmissiveForStaticLighting = FALSE;
	LightmassSettings.EmissiveBoost	= 1.0f;
	LightmassSettings.DiffuseBoost	= 1.0f;
	LightmassSettings.SpecularBoost	= 1.0f;
}
