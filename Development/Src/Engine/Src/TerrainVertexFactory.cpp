...
IMPLEMENT_VERTEX_FACTORY_TYPE(FTerrainVertexFactory, FTerrainVertexFactoryShaderParameters, "TerrainVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_TERRAIN_REMOVED_DISPLACEMENTS,0);
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FTerrainDecalVertexFactory, FTerrainDecalVertexFactoryShaderParameters, "TerrainVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_TERRAIN_REMOVED_DISPLACEMENTS,0);
...
/** bind terrain vertex factory to its shader file and its shader parameters */
IMPLEMENT_VERTEX_FACTORY_TYPE(FTerrainMorphVertexFactory, FTerrainVertexFactoryShaderParameters, "TerrainVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_TERRAIN_REMOVED_DISPLACEMENTS,0);
...
/** bind terrain decal vertex factory to its shader file and its shader parameters */
IMPLEMENT_VERTEX_FACTORY_TYPE(FTerrainMorphDecalVertexFactory, FTerrainDecalVertexFactoryShaderParameters, "TerrainVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_TERRAIN_REMOVED_DISPLACEMENTS,0);
...
/** bind terrain vertex factory to its shader file and its shader parameters */
IMPLEMENT_VERTEX_FACTORY_TYPE(FTerrainFullMorphVertexFactory, FTerrainVertexFactoryShaderParameters, "TerrainVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_TERRAIN_REMOVED_DISPLACEMENTS,0);
...
/** bind terrain decal vertex factory to its shader file and its shader parameters */
IMPLEMENT_VERTEX_FACTORY_TYPE(FTerrainFullMorphDecalVertexFactory, FTerrainDecalVertexFactoryShaderParameters, "TerrainVertexFactory", TRUE, TRUE, TRUE, FALSE, VER_TERRAIN_REMOVED_DISPLACEMENTS,0);
