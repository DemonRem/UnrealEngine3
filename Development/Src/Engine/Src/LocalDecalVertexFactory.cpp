...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLocalDecalVertexFactory,FLocalDecalVertexFactoryShaderParameters,"LocalVertexFactory",TRUE,TRUE,TRUE,FALSE,VER_VERTEX_FACTORY_LOCALTOWORLD_FLIP,0);
