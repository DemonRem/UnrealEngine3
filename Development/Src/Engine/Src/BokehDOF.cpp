	...
	UBOOL bSeparateTranslucency)
{
	...
	FViewPortBounds ViewPortBounds[4] =
	{
		...
		FViewPortBounds(0, HalfSizeY,				HalfTargetSizeX, HalfTargetSizeY),		// second background half res
		FViewPortBounds(HalfSizeX, HalfSizeY,		HalfTargetSizeX, HalfTargetSizeY),		// second foreground half res
	};

	RHISetMultipleViewports(4, ViewPortBounds);
