...
public:
		...
		UBOOL bAnalyticalSpecular)
	{
		...
		SetPixelShaderValue(GetPixelShader(),SpecularScaleParameter,bAnalyticalSpecular ? 1.0f : 0.0f);
...
#endif
		{
			PixelShader->SetParameters(MaterialRenderProxy,View,bReceiveDynamicShadows,bUseTranslucencyLightAttenuation,!Light->bUseImageReflectionSpecular);
