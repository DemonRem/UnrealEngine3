...
public:
	...
	*/
	void AddScenePrimitive(FPrimitiveSceneInfo* PrimitiveSceneInfo,const FViewInfo& ViewInfo, UBOOL bUsesSceneColor, UBOOL bNeedsDepthPrepass, UBOOL bNeedsDepthPostpass, UBOOL bUseSeparateTranslucency);
	...
	*/
	INT NumPrims() const
	{
		return SortedPrims.Num() + SortedSceneColorPrims.Num() + SortedSeparateTranslucencyPrims.Num();
	}
...
private:
	 ...
	 */
	void GenerateChildSceneInfos(const FPrimitiveSceneInfo* InPrimitiveSceneInfo, TArray <FPrimitiveSceneInfo*, SceneRenderingAllocator>& OutChildSceneInfos) const;
	 ...
	 */
	FORCEINLINE BYTE GatherShadowsForPrimitiveInner(const FPrimitiveSceneInfoCompact& PrimitiveSceneInfoCompact, BYTE ValidViews,
	...
	*/
	 ...
	 */
	FORCEINLINE BYTE ProcessPrimitiveCullingInner(const FPrimitiveSceneInfoCompact& CompactPrimitiveSceneInfo, BYTE ValidViews, INT Depth);
