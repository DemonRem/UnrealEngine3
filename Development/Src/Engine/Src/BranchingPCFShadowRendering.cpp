...
IMPLEMENT_BPCF_SHADER_TYPE(FLowQualityManualPCF,LowQualityShaderName,TEXT("BranchingPCFProjectionPixelShader"),TEXT("Main"),SF_Pixel, VER_IMPLEMENTED_FETCH4);

typedef FBranchingPCFProjectionPixelShader<FMediumQualityManualPCF> MediumQualityShaderName;
IMPLEMENT_BPCF_SHADER_TYPE(FMediumQualityManualPCF,MediumQualityShaderName,TEXT("BranchingPCFProjectionPixelShader"),TEXT("Main"),SF_Pixel, VER_IMPLEMENTED_FETCH4);

typedef FBranchingPCFProjectionPixelShader<FHighQualityManualPCF> HighQualityShaderName;
IMPLEMENT_BPCF_SHADER_TYPE(FHighQualityManualPCF,HighQualityShaderName,TEXT("BranchingPCFProjectionPixelShader"),TEXT("Main"),SF_Pixel, VER_IMPLEMENTED_FETCH4);

// 3 quality levels of hardware PCF
typedef FBranchingPCFProjectionPixelShader<FLowQualityHwPCF> HwPCFLowQualityShaderName;
IMPLEMENT_BPCF_SHADER_TYPE(FLowQualityHwPCF,HwPCFLowQualityShaderName,TEXT("BranchingPCFProjectionPixelShader"),TEXT("HardwarePCFMain"),SF_Pixel, VER_IMPLEMENTED_FETCH4);

typedef FBranchingPCFProjectionPixelShader<FMediumQualityHwPCF> HwPCFMediumQualityShaderName;
IMPLEMENT_BPCF_SHADER_TYPE(FMediumQualityHwPCF,HwPCFMediumQualityShaderName,TEXT("BranchingPCFProjectionPixelShader"),TEXT("HardwarePCFMain"),SF_Pixel, VER_IMPLEMENTED_FETCH4);

typedef FBranchingPCFProjectionPixelShader<FHighQualityHwPCF> HwPCFHighQualityShaderName;
IMPLEMENT_BPCF_SHADER_TYPE(FHighQualityHwPCF,HwPCFHighQualityShaderName,TEXT("BranchingPCFProjectionPixelShader"),TEXT("HardwarePCFMain"),SF_Pixel, VER_IMPLEMENTED_FETCH4);
