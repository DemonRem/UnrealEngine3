...
#if UDK
	FNetControlMessage<NMT_Hello>::Send(Connection, PlatformType, GEngineMinNetVersion, GEngineVersion, GModGUID);
#else
	FNetControlMessage<NMT_Hello>::Send(Connection, PlatformType, GEngineMinNetVersion, GEngineVersion);
#endif // UDK
	Connection->FlushNet();
