	...
	void DrawShared(const FSceneView* View,FBoundShaderStateRHIParamRef BoundShaderState) const
	{
...
#endif
		{
			...
			case BLEND_Translucent:
...
#if !CONSOLE
					if(GSystemSettings.RenderThreadSettings.bAllowSeparateTranslucencyRT && GRHIShaderPlatform == SP_PCD3D_SM5)
					{
				...
				break;
			case BLEND_Additive:
				if(GRHIShaderPlatform == SP_PCD3D_SM5 && GSystemSettings.RenderThreadSettings.bAllowSeparateTranslucencyRT)
				{
