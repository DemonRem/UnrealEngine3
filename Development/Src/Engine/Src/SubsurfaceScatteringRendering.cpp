...
#include "ScreenRendering.h"
	...
	public:
		...
		{
			SceneTextureParameters.Set(&View,this,SF_Point,GSceneRenderTargets.GetSceneColorTexture());
			...
			if(SubsurfaceScatteringAttenuationSurfaceParameter.IsBound())
			{
				RHISetSurfaceParameter(
					GetPixelShader(),
					SubsurfaceScatteringAttenuationSurfaceParameter.GetBaseIndex(),
	...
	#define IMPLEMENT_SUBSURFACE_SCATTERING_SHADER(NumSamplePairs,NumRadialStrata,NumAngularStrata) \
		...
		IMPLEMENT_SHADER_TYPE(,FPerPixelSubsurfaceScatteringPixelShader##NumSamplePairs,TEXT("SubsurfaceScatteringPixelShader"),TEXT("Main"),SF_Pixel,0,0); \
		...
		IMPLEMENT_SHADER_TYPE(,FPerFragmentSubsurfaceScatteringPixelShader##NumSamplePairs,TEXT("SubsurfaceScatteringPixelShader"),TEXT("Main"),SF_Pixel,0,0); \
		...
		IMPLEMENT_SHADER_TYPE(,FSubsurfaceScatteringPixelShader##NumSamplePairs,TEXT("SubsurfaceScatteringPixelShader"),TEXT("Main"),SF_Pixel,0,0);
