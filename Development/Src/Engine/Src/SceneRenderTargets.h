...
public:
	 ...
	 * @param ResolveParams - optional resolve params
	 */
	void FinishRenderingShadowDepth(UBOOL bIsWholeSceneDominantShadow, const FResolveParams& ResolveParams = FResolveParams());
	...
	void FinishRenderingAOInput(const FResolveParams& ResolveParams);

	void BeginRenderingAOOutput(UBOOL bUseDownsizedDepthBuffer = FALSE);
	void FinishRenderingAOOutput(const FResolveParams& ResolveParams);
