...
#if !defined(IPHONE) && !defined(ANDROID)		// #pragma push_macro doesn't work in some compilers
...
// Mobile platforms do not yet support PhysX extensions like QuickLoadConvex
#if IPHONE || ANDROID
