...
public:
    ...
    BITFIELD bAttenuateWithLowPassFilter_DEPRECATED:1;
    FLOAT dBAttenuationAtMax;
    BYTE DistanceAlgorithm;
    BYTE DistanceType;
    BYTE DistanceModel_DEPRECATED;
    FLOAT RadiusMin;
    FLOAT RadiusMax;
    FLOAT LPFRadiusMin;
    FLOAT LPFRadiusMax;
    struct FRawDistributionFloat MinRadius_DEPRECATED;
    struct FRawDistributionFloat MaxRadius_DEPRECATED;
    struct FRawDistributionFloat LPFMinRadius_DEPRECATED;
    struct FRawDistributionFloat LPFMaxRadius_DEPRECATED;
...
public:
    ...
    class USoundNodeWave* Wave_DEPRECATED;
    struct FRawDistributionFloat MinRadius_DEPRECATED;
    struct FRawDistributionFloat MaxRadius_DEPRECATED;
    struct FRawDistributionFloat LPFMinRadius_DEPRECATED;
    struct FRawDistributionFloat LPFMaxRadius_DEPRECATED;
...
VERIFY_CLASS_OFFSET_NODIE(USoundNodeAmbient,SoundNodeAmbient,VolumeModulation_DEPRECATED)
...
VERIFY_CLASS_OFFSET_NODIE(USoundNodeAttenuation,SoundNodeAttenuation,LPFMaxRadius_DEPRECATED)
