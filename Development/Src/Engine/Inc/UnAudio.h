...
public:
	...
	/** 
	 * Returns TRUE if radio distortion should be applied; FALSE, otherwise.
	 */
	UBOOL IsRadioDistortionApplied( void ) const 
	{	
	 ...
	 */
	UBOOL SetRadioDistortionApplied( void );
...
protected:
	...
	/** Cached sound mode value used to apply radio distortion. */
	UBOOL				bRadioDistortionApplied;
