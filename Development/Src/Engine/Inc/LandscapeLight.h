...
public:
	// tors
	FLandscapeStaticLightingMesh(ULandscapeComponent* InComponent,const TArray<ULightComponent*>& InRelevantLights, INT InExpandQuadsX, INT InExpandQuadsY, INT InSizeX, INT InSizeY);
