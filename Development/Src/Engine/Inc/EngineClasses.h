...
{
    FStringNoInit ProjectileClassName;
...
public:
    ...
    TArrayNoInit<struct FPlayerInformationNew> PlayerList;
...
public:
    ...
    BITFIELD bEnableDepthOfFieldHQ_DEPRECATED:1;
    SCRIPT_ALIGN;
...
VERIFY_CLASS_OFFSET_NODIE(UOnlineGameplayEvents,OnlineGameplayEvents,PlayerList)
VERIFY_CLASS_OFFSET_NODIE(UOnlineGameplayEvents,OnlineGameplayEvents,GameplaySessionID)
...
VERIFY_CLASS_OFFSET_NODIE(UOnlineGameSearch,OnlineGameSearch,PingBucketSize)
