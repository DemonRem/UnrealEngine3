...
{
	return Platform == SP_PCD3D_SM3	|| Platform == SP_PCD3D_SM5;
}
...
FORCEINLINE EMaterialShaderPlatform GetMaterialPlatform(EShaderPlatform ShaderPlatform)
{
	...
	checkSlow(SP_NumPlatforms == 6);
	static const EMaterialShaderPlatform MaterialPlatformTable[] = { MSP_SM3, MSP_SM3, MSP_SM3, MSP_SM3, MSP_SM3, MSP_SM3 };
