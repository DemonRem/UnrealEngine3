...
struct FLinkedObjConnInfo
{
	...
	FLinkedObjConnInfo( const TCHAR* InName, const FColor& InColor, UBOOL InMoving = FALSE, UBOOL InNewConnection = TRUE, INT InOverrideDelta = 0, const UBOOL InbOutput = 0 )
	{
		Name = InName;
		Color = InColor;
		bOutput = InbOutput;
...
public:
	...
	*/
	static INT DrawStringWrapped( FCanvas* Canvas, UBOOL Draw, FLOAT CurX, FLOAT CurY, FLOAT& XL, FLOAT& YL, UFont* Font, const TCHAR* Text, FLinearColor DrawColor );
