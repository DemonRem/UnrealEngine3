...
struct FTerrainBV
{
	 ...
	 */
	UBOOL LineCheck(FTerrainBVTreeLineCollisionCheck& Check, FLOAT& HitTime) const;	
	 ...
	 */
	UBOOL PointCheck(FTerrainBVTreeLineCollisionCheck& Check) const;
	...
	/** Set the bounding volume to encompass this subregion of the terrain. */
...
struct FTerrainBVNode
{
	...
	/**
	 *	Take a region of the terrain and either store it in this node or, if its too big, split into child nodes
