...
extern void DrawStringWrappedZ( FCanvas* Canvas, UBOOL Draw, FLOAT CurX, FLOAT CurY, FLOAT Z, FLOAT& XL, FLOAT& YL, UFont* Font, const TCHAR* Text, FLinearColor DrawColor );
