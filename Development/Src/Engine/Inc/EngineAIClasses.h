...
public:
    ...
    virtual FString GetPathCacheDebugText();
    ...
    DECLARE_FUNCTION(execGetPathCacheDebugText)
    {
        P_FINISH;
        *(FString*)Result=this->GetPathCacheDebugText();
    }
...
AUTOGENERATE_FUNCTION(UNavigationHandle,-1,execGetPathCacheDebugText);
...
{ 
	...
	MAP_NATIVE(UNavigationHandle, execGetPathCacheDebugText)
...
VERIFY_CLASS_OFFSET_NODIE(UNavigationHandle,NavigationHandle,LastPathFailTime)
...
VERIFY_CLASS_OFFSET_NODIE(UNavMeshPath_MinDistBetweenSpecsOfType,NavMeshPath_MinDistBetweenSpecsOfType,EdgeType)
