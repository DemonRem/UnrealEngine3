...
#define VER_MIN_MATERIALSHADERMAP				VER_INVALIDATE_SHADERCACHE1
/** The minimum package version to load material pixel shaders with. */
#define VER_MIN_MATERIAL_PIXELSHADER			VER_INVALIDATE_SHADERCACHE1
/** The minimum package version to load material vertex shaders with. */
#define VER_MIN_MATERIAL_VERTEXSHADER			VER_INVALIDATE_SHADERCACHE1
...
public:
	...
	void RemovePendingMaterial(FMaterial* Material);
