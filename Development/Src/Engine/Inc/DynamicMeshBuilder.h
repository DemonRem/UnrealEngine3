...
struct FDynamicMeshVertex
{
	...
	FDynamicMeshVertex(const FVector& InPosition,const FVector& InTangentX,const FVector& InTangentZ,const FVector2D& InTexCoord):
		Position(InPosition),
...
public:
	 ...
	 */
	void Draw(FPrimitiveDrawInterface* PDI,const FMatrix& LocalToWorld,const FMaterialRenderProxy* MaterialRenderProxy,BYTE DepthPriorityGroup);
