...
FIndexBufferRHIRef FD3D11DynamicRHI::CreateIndexBuffer(UINT Stride,UINT Size,FResourceArrayInterface* ResourceArray,DWORD InUsage)
{
	...
	return new FD3D11IndexBuffer(IndexBufferResource, Stride);
}

FIndexBufferRHIRef FD3D11DynamicRHI::CreateInstancedIndexBuffer(UINT Stride,UINT Size,DWORD InUsage,UINT& OutNumInstances)
{
