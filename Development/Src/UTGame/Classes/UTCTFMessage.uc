...
// FIXMESTEVE - unique messages for each case!!!

class UTCTFMessage extends UTLocalMessage;
...
defaultproperties
{
	ReturnSounds(0)=SoundNodeWave'A_Announcer_FemaleUT.Announcements.Announcer_FemaleUT_RedFlagReturned'
	ReturnSounds(1)=SoundNodeWave'A_Announcer_FemaleUT.Announcements.Announcer_FemaleUT_BlueFlagReturned'
	DroppedSounds(0)=SoundNodeWave'A_Announcer_FemaleUT.Announcements.Announcer_FemaleUT_RedFlagDropped'
	DroppedSounds(1)=SoundNodeWave'A_Announcer_FemaleUT.Announcements.Announcer_FemaleUT_BlueFlagDropped'
	TakenSounds(0)=SoundNodeWave'A_Announcer_FemaleUT.Announcements.Announcer_FemaleUT_RedFlagTaken'
	TakenSounds(1)=SoundNodeWave'A_Announcer_FemaleUT.Announcements.Announcer_FemaleUT_BlueFlagTaken'
	...
	//    Riffs(0)=soundcue'GameSounds.UT2K3Fanfare01'
	//    Riffs(1)=soundcue'GameSounds.UT2K3Fanfare04'
	//    Riffs(2)=soundcue'GameSounds.UT2K3Fanfare06'
}
