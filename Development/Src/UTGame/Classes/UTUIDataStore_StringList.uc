 ...
 */
native function AddStr(name FieldName, string NewString);
 ...
 */
native function InsertStr(name FieldName, string NewString, int InsertIndex);
 ...
 */
native function RemoveStr(name FieldName, string StringToRemove);
 ...
 */
native function RemoveStrByIndex(name FieldName, int Index, optional int Count=1);
 ...
 * @Param FieldName		The string list to work on
 */
native function Empty(name FieldName);
