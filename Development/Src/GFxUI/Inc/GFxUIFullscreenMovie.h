...
Filename    :   GFxUIFullscreenMovie.h
Content     :   
...
{
	GFxLoader*          Loader;
	class FGFxRendererRT* Renderer;
	UBOOL               FontlibInitialized;
	FString             MovieFilename;
	GPtr<GFxMovieDef>   MovieDef;
	GPtr<GFxMovieView>  MovieView;
	GMutex              Mutex;
	GAtomicInt<SInt32>  DoStop;
	GAtomicInt<SInt32>  IsStopped;
	GWaitCondition      MovieFinished;
