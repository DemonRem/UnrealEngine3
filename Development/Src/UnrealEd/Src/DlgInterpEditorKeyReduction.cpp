	...
	OkayButton(NULL), CancelButton(NULL)
{
	...
	FullIntervalLabel = new wxStaticText(this, wxID_ANY, TEXT("DlgInterpEditorKeyReductionFullInterval"), wxPoint(3, 5 + RowHeight), wxSize(138, RowHeight));
	IntervalStartLabel = new wxStaticText(this, wxID_ANY, TEXT("DlgInterpEditorKeyReductionIntervalStart"), wxPoint(3, 7 + RowHeight * 2), wxSize(138, RowHeight));
	IntervalEndLabel = new wxStaticText(this, wxID_ANY, TEXT("DlgInterpEditorKeyReductionIntervalEnd"), wxPoint(3, 9 + RowHeight * 3), wxSize(138, RowHeight));
