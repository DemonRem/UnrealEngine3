	  ...
	  StaticMesh( NULL )
{
	...
	wxBoxSizer* MainVerticalSizer = new wxBoxSizer(wxVERTICAL);
	{
		...
		{
			wxStaticText* InputMinChartSpacingPercentText = new wxStaticText(this, wxID_ANY, *LocalizeUnrealEd("GenerateUniqueUVs_MinChartSpacingPercentText"));
		...
		{
			wxStaticText* InputKeepExistingUVText = new wxStaticText(this, wxID_ANY, *LocalizeUnrealEd("KeepExistingUVText"));
...
void WxGenerateUVsWindow::OnApply(wxCommandEvent& In )
{
...

	{
		...
		if (GenerateUVs(StaticMesh, ChosenLODIndex, ChosenTexIndex, bKeepExistingUVs, MinChartSpacingPercent, BorderSpacingPercent, bUseMaxStretch, FalseEdgeIndicesPtr, MaxCharts, MaxStretch))
		{
