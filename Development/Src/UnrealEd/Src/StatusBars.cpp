...
void WxStatusBarStandard::SetUp()
{
	...
	const INT Widths[] = { ExecComboPane, SourceControlPane, LightingPane, PathsPane, PackageCheckoutPane, -2, ActorNamePane, MousePosPane, ScaleWidths, ScaleWidths, ScaleWidths, ScaleWidths, DragGridPane, RotationGridPane, ScaleGridPane, AutosavePane, BufferPane };
...
void WxStatusBarStandard::UpdateUI()
{
	...
	else
	{
		...
		{
			ActorNameString.Printf(LocalizeSecure(LocalizeUnrealEd("ActorsClassSelected"), NumActorsToDisplay, *ActorClassString));
		}
		else
		{
			ActorNameString.Printf(LocalizeSecure(LocalizeUnrealEd("ActorsSelected"), NumActorsToDisplay));
		}
