...
//////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNAMIC_CLASS(WxCustomPropertyItem_MaterialInstanceConstantParameter, WxCustomPropertyItem_ConditonalItem);

BEGIN_EVENT_TABLE(WxCustomPropertyItem_MaterialInstanceConstantParameter, WxCustomPropertyItem_ConditonalItem)
					...
					UBOOL bInSupportsCustomControls )
{
	...
	{
		ResetToDefault = new wxBitmapButton( this, ID_MATERIALINSTANCE_CONSTANT_EDITOR_RESETTODEFAULT, GPropertyWindowManager->Prop_ResetToDefaultB );
		IndentX += 15;
