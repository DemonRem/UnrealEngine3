...
private:
	...
	TMap<INT, TArray<struct FPlayerInformationNew> > PlayerListBySessionDBID;
...
public:
    ...
    */
	...
	virtual void GetPlayersListBySessionDBID(INT SessionDBID, TArray<struct FPlayerInformationNew>& OutPlayerList);
	 ...
	 * @return TRUE if successful, FALSE otherwise
	 */
	UBOOL AddPlayerMetadata(const TArray<struct FPlayerInformationNew>& PlayerMetadata);
	/** 
