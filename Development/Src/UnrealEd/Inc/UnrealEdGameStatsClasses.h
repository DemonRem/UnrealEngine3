...
public:
    ...
    TMap<FString, TArray<struct FPlayerInformationNew> > PlayerListBySessionID;
    ...
    virtual void GetPlayersListBySessionID(const FString& SessionId,TArray<struct FPlayerInformationNew>& OutPlayerList);
    ...
    {
        P_GET_STR(SessionId);
        P_GET_TARRAY_REF(struct FPlayerInformationNew,OutPlayerList);
        P_FINISH;
