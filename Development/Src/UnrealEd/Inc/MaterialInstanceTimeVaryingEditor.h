 ...
 */
class WxCustomPropertyItem_MaterialInstanceTimeVaryingParameter : public WxCustomPropertyItem_ConditonalItem
{
public:
 ...
 */
class WxPropertyWindow_MaterialInstanceTimeVaryingParameters : public WxPropertyWindow_Item
{
public:
