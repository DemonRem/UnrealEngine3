...
struct FEditorLevelViewportClient : public FViewportClient, public FViewElementDrawer, public FCallbackEventDevice
{
public:
	////////////////////////////
	// Viewport parameters
	...
	*/
	...
	/** List of groups that are hidden in this view */
	TArray<FName>			ViewHiddenGroups;
