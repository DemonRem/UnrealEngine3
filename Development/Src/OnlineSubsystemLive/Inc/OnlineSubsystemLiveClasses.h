...
public:
    ...
    virtual UBOOL GetSaveGameData(BYTE LocalUserNum,INT DeviceID,const FString& FriendlyName,const FString& Filename,const FString& SaveFileName,TArray<BYTE>& SaveGameData);
    ...
    DECLARE_FUNCTION(execGetSaveGameData)
    {
        ...
        P_FINISH;
        *(UBOOL*)Result=this->GetSaveGameData(LocalUserNum,DeviceID,FriendlyName,Filename,SaveFileName,SaveGameData);
    }
