		...
		// video card
		{
			...
			if (SUCCEEDED(D3DObject->GetAdapterIdentifier(D3DADAPTER_DEFAULT, 0, &AdapterId)))
			{
				...
				switch (DeviceCompatLevel)
				{
					...
					case 1:
					case 2:
						GConfig->SetInt(TEXT("SystemSettings"), TEXT("ResX"),  640, GEngineIni);
						GConfig->SetInt(TEXT("SystemSettings"), TEXT("ResY"),  480, GEngineIni);
						GConfig->Flush( FALSE, GEngineIni );
						break;
					case 3:
						GConfig->SetInt(TEXT("SystemSettings"), TEXT("ResX"),  800, GEngineIni);
						GConfig->SetInt(TEXT("SystemSettings"), TEXT("ResY"),  600, GEngineIni);
						GConfig->Flush( FALSE, GEngineIni );
						break;
					case 4:
					case 5:
