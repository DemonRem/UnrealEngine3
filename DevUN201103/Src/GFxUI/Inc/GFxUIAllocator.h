...
#ifndef GFxUIAllocator_h
#define GFxUIAllocator_h
...
{
public:
    UInt m_TotalAlloc, m_FrameAllocPeak;
    ...
    virtual UPInt   GetFootprint() const { return m_TotalAlloc; }
    virtual UPInt   GetUsedSpace() const { return m_TotalAlloc; }
};

#endif // WITH_GFx

#endif // GFxUIAllocator_h
