...
struct SeqAct_GameCrowdSpawner_eventSpawnAgent_Parms
{
    class AActor* SpawnLoc;
    class AGameCrowdAgent* ReturnValue;
    SeqAct_GameCrowdSpawner_eventSpawnAgent_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    TArrayNoInit<class AGameCrowdAgent*> SpawnedList;
    FLightingChannelContainer AgentLightingChannel;
    class AGameCrowdReplicationActor* RepActor;
    FLOAT AgentWarmupTime;
    //## END PROPS SeqAct_GameCrowdSpawner

    virtual void SpawnedAgent(class AGameCrowdAgent* NewAgent);
    virtual void CacheSpawnerVars();
    virtual void KillAgents();
    virtual void UpdateSpawning(FLOAT DeltaSeconds);
    DECLARE_FUNCTION(execSpawnedAgent)
    {
        P_GET_OBJECT(AGameCrowdAgent,NewAgent);
        P_FINISH;
        this->SpawnedAgent(NewAgent);
    }
    DECLARE_FUNCTION(execCacheSpawnerVars)
    {
        P_FINISH;
        this->CacheSpawnerVars();
    }
    ...
    {
        SeqAct_GameCrowdSpawner_eventSpawnAgent_Parms Parms(EC_EventParm);
        Parms.ReturnValue=NULL;
        Parms.SpawnLoc=SpawnLoc;
        ProcessEvent(FindFunctionChecked(GAMEFRAMEWORK_SpawnAgent),&Parms);
        return Parms.ReturnValue;
    }
    DECLARE_ABSTRACT_CLASS(USeqAct_GameCrowdSpawner,USeqAct_Latent,0,GameFramework)
...
struct GameCrowdAgent_eventSetPanic_Parms
{
    class AActor* PanicActor;
    UBOOL bNewPanic;
    GameCrowdAgent_eventSetPanic_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    TArrayNoInit<class AActor*> NearbyDynamics;
    TArrayNoInit<class AGameCrowdForcePoint*> RelevantAttractors;
    ...
    BITFIELD bClampMovementSpeed:1;
    ...
    FLOAT AvoidPlayerStrength;
    FLOAT AvoidOtherRadius;
    FLOAT GroupAttractionStrength;
    ...
    FLOAT NotVisibleTickScalingFactor;
    ...
    FLOAT ForceAmountToIgnorePathForces;
    ...
    void eventSetPanic(class AActor* PanicActor,UBOOL bNewPanic)
    {
        GameCrowdAgent_eventSetPanic_Parms Parms(EC_EventParm);
        Parms.PanicActor=PanicActor;
        Parms.bNewPanic=bNewPanic ? FIRST_BITFIELD : FALSE;
        ProcessEvent(FindFunctionChecked(GAMEFRAMEWORK_SetPanic),&Parms);
    }
...
public:
    ...
    FLOAT DurationOfPanic;
    FLOAT TimeToStopPanic;
...
public:
    ...
    BITFIELD bLastAllowableResult:1;
...
struct GameCrowdForcePoint_eventAppliedForce_Parms
{
    class AGameCrowdAgent* Agent;
    FVector ReturnValue;
    GameCrowdForcePoint_eventAppliedForce_Parms(EEventParm)
    {
    }
};
...
{
public:
    //## BEGIN PROPS GameCrowdForcePoint
    //## END PROPS GameCrowdForcePoint

    FVector eventAppliedForce(class AGameCrowdAgent* Agent)
    {
        GameCrowdForcePoint_eventAppliedForce_Parms Parms(EC_EventParm);
        appMemzero(&Parms.ReturnValue,sizeof(Parms.ReturnValue));
        Parms.Agent=Agent;
        ProcessEvent(FindFunctionChecked(GAMEFRAMEWORK_AppliedForce),&Parms);
        return Parms.ReturnValue;
    }
    DECLARE_ABSTRACT_CLASS(AGameCrowdForcePoint,AGameCrowdInteractionPoint,0,GameFramework)
	virtual void TickSpecial( FLOAT DeltaSeconds );
...
{
public:
    //## BEGIN PROPS GameCrowdAttractor
    FLOAT Attraction;
    BITFIELD bAttractionFalloff:1;
    SCRIPT_ALIGN;
    //## END PROPS GameCrowdAttractor

    DECLARE_CLASS(AGameCrowdAttractor,AGameCrowdForcePoint,0,GameFramework)
    NO_DEFAULT_CONSTRUCTOR(AGameCrowdAttractor)
};

class AGameCrowdRepulsor : public AGameCrowdForcePoint
{
public:
    //## BEGIN PROPS GameCrowdRepulsor
    FLOAT Repulsion;
    BITFIELD bAttractionFalloff:1;
    SCRIPT_ALIGN;
    //## END PROPS GameCrowdRepulsor

    DECLARE_CLASS(AGameCrowdRepulsor,AGameCrowdForcePoint,0,GameFramework)
    NO_DEFAULT_CONSTRUCTOR(AGameCrowdRepulsor)
};

struct GameCrowdPopulationManager_eventSpawnAgent_Parms
{
    class AGameCrowdDestination* SpawnLoc;
    class AGameCrowdAgent* ReturnValue;
    GameCrowdPopulationManager_eventSpawnAgent_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    BITFIELD bForceObstacleChecking:1;
    BITFIELD bForceNavMeshPathing:1;
    BITFIELD bHaveInitialPopulation:1;
    BITFIELD bWarmupPosition:1;
    FLOAT SpawnRate;
    INT SpawnNum;
    FLOAT SplitScreenNumReduction;
    ...
    FLOAT AgentFrequencySum;
    TArrayNoInit<struct FAgentArchetypeInfo> AgentArchetypes;
    TArrayNoInit<class AGameCrowdAgent*> AgentPool;
    INT MaxAgentPoolSize;
    INT AgentCount;
    FLightingChannelContainer AgentLightingChannel;
    FLOAT AgentWarmupTime;
    ...
    {
        GameCrowdPopulationManager_eventSpawnAgent_Parms Parms(EC_EventParm);
        Parms.ReturnValue=NULL;
        Parms.SpawnLoc=SpawnLoc;
        ProcessEvent(FindFunctionChecked(GAMEFRAMEWORK_SpawnAgent),&Parms);
        return Parms.ReturnValue;
...
struct SeqAct_GameCrowdPopulationManagerToggle_eventFindPopMgrTarget_Parms
{
    SeqAct_GameCrowdPopulationManagerToggle_eventFindPopMgrTarget_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    FLOAT WarmupPct;
    BITFIELD bKillAgentsInstantly:1;
    ...
    {
        ProcessEvent(FindFunctionChecked(GAMEFRAMEWORK_FindPopMgrTarget),NULL);
    }
...
AUTOGENERATE_FUNCTION(UGameCrowdBehavior_RunFromPanic,-1,execTick);
...
AUTOGENERATE_FUNCTION(USeqAct_GameCrowdSpawner,-1,execUpdateSpawning);
AUTOGENERATE_FUNCTION(USeqAct_GameCrowdSpawner,-1,execKillAgents);
AUTOGENERATE_FUNCTION(USeqAct_GameCrowdSpawner,-1,execCacheSpawnerVars);
AUTOGENERATE_FUNCTION(USeqAct_GameCrowdSpawner,-1,execSpawnedAgent);
...
#define AUTO_INITIALIZE_REGISTRANTS_GAMEFRAMEWORK \
	...
	GNativeLookupFuncs.Set(FName("GameCrowdBehavior_RunFromPanic"), GGameFrameworkUGameCrowdBehavior_RunFromPanicNatives); \
	...
	AGameCrowdForcePoint::StaticClass(); \
	AGameCrowdAttractor::StaticClass(); \
	AGameCrowdRepulsor::StaticClass(); \
	...
	GNativeLookupFuncs.Set(FName("SeqAct_GameCrowdSpawner"), GGameFrameworkUSeqAct_GameCrowdSpawnerNatives); \
...
FNativeFunctionLookup GGameFrameworkUGameCrowdBehavior_RunFromPanicNatives[] = 
{ 
	MAP_NATIVE(UGameCrowdBehavior_RunFromPanic, execTick)
	{NULL, NULL}
};
...
FNativeFunctionLookup GGameFrameworkUSeqAct_GameCrowdSpawnerNatives[] = 
{ 
	MAP_NATIVE(USeqAct_GameCrowdSpawner, execUpdateSpawning)
	MAP_NATIVE(USeqAct_GameCrowdSpawner, execKillAgents)
	MAP_NATIVE(USeqAct_GameCrowdSpawner, execCacheSpawnerVars)
	MAP_NATIVE(USeqAct_GameCrowdSpawner, execSpawnedAgent)
	{NULL, NULL}
};
...
VERIFY_CLASS_OFFSET_NODIE(AGameCrowdAgent,GameCrowdAgent,ForceAmountToIgnorePathForces)
...
VERIFY_CLASS_OFFSET_NODIE(UGameCrowdAgentBehavior,GameCrowdAgentBehavior,ActionTarget)
VERIFY_CLASS_OFFSET_NODIE(UGameCrowdAgentBehavior,GameCrowdAgentBehavior,MyAgent)
...
VERIFY_CLASS_OFFSET_NODIE(UGameCrowdBehavior_RunFromPanic,GameCrowdBehavior_RunFromPanic,TimeToStopPanic)
...
VERIFY_CLASS_SIZE_NODIE(AGameCrowdForcePoint)
VERIFY_CLASS_OFFSET_NODIE(AGameCrowdAttractor,GameCrowdAttractor,Attraction)
VERIFY_CLASS_SIZE_NODIE(AGameCrowdAttractor)
VERIFY_CLASS_OFFSET_NODIE(AGameCrowdRepulsor,GameCrowdRepulsor,Repulsion)
VERIFY_CLASS_SIZE_NODIE(AGameCrowdRepulsor)
VERIFY_CLASS_OFFSET_NODIE(AGameCrowdPopulationManager,GameCrowdPopulationManager,SpawnRate)
VERIFY_CLASS_OFFSET_NODIE(AGameCrowdPopulationManager,GameCrowdPopulationManager,QueryingAgent)
...
VERIFY_CLASS_OFFSET_NODIE(USeqAct_GameCrowdPopulationManagerToggle,SeqAct_GameCrowdPopulationManagerToggle,WarmupPct)
VERIFY_CLASS_OFFSET_NODIE(USeqAct_GameCrowdPopulationManagerToggle,SeqAct_GameCrowdPopulationManagerToggle,PopulationManagerClass)
VERIFY_CLASS_SIZE_NODIE(USeqAct_GameCrowdPopulationManagerToggle)
VERIFY_CLASS_OFFSET_NODIE(USeqAct_GameCrowdSpawner,SeqAct_GameCrowdSpawner,NextDestinationIndex)
VERIFY_CLASS_OFFSET_NODIE(USeqAct_GameCrowdSpawner,SeqAct_GameCrowdSpawner,AgentWarmupTime)
