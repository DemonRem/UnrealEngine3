	...
	)
{
	...
	return new FD3D11Surface(RenderTargetView,DepthStencilView,ReadOnlyDepthStencilView,ShaderResourceView,ResolveTargetTexture,NULL,SurfaceResource);
}
	...
	)
{
	...
	else
	{
		...
		return new FD3D11Surface(RenderTargetView,DepthStencilView,DepthStencilView,ShaderResourceView,NULL,ResolveTargetTexture,SurfaceResource);
	}
}
