...
FD3D11Texture2D* FD3D11DynamicRHI::CreateD3D11Texture2D(UINT SizeX,UINT SizeY,UINT SizeZ,UBOOL bTextureArray,UBOOL CubeTexture,BYTE Format,UINT NumMips,DWORD Flags)
{
	...
	FD3D11Texture2D* Texture2D = new FD3D11Texture2D(this,TextureResource,TextureView,TextureRTV,TextureDSV,SizeX,SizeY,SizeZ,NumMips,(EPixelFormat)Format,CubeTexture);
...
FD3D11Texture3D* FD3D11DynamicRHI::CreateD3D11Texture3D(UINT SizeX,UINT SizeY,UINT SizeZ,BYTE Format,UINT NumMips,DWORD Flags,const BYTE* Data)
{
	...
	FD3D11Texture3D* Texture3D = new FD3D11Texture3D(this,TextureResource,TextureView,SizeX,SizeY,SizeZ,NumMips,(EPixelFormat)Format);
	return Texture3D;
}
...
template<ERHIResourceTypes ResourceTypeEnum>
void TD3D11Texture2D<ResourceTypeEnum>::Unlock(UINT MipIndex,UINT ArrayIndex)
{
...
-----------------------------------------------------------------------------*/
FSharedMemoryResourceRHIRef FD3D11DynamicRHI::CreateSharedMemory(SIZE_T Size)
{
...
FTexture2DRHIRef FD3D11DynamicRHI::CreateStereoFixTexture()
{
	...
	return new FD3D11Texture2D(this,TextureResource,TextureView,NULL,NULL,SizeX,SizeY,1,1,PF_G32R32F,false);
}
