...
INT						GTonemapperType					= -1;						/* see "TonemapperType" console command help */
...
DECLARE_MEMORY_STAT(TEXT("Lightmap Memory (Vertex)"),STAT_VertexLightingMemory,STATGROUP_Memory);
...
DECLARE_MEMORY_STAT(TEXT("Scene VertexShader Memory"),STAT_SceneVertexShaderMemory,STATGROUP_Memory);
DECLARE_MEMORY_STAT(TEXT("Scene PixelShader Memory"),STAT_ScenePixelShaderMemory,STATGROUP_Memory);
#endif
