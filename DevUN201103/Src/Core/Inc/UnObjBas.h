...
public:
	 ...
	 */
	static void LoadPackageAsync( const FString& PackageName, FAsyncCompletionCallback CompletionCallback, void* CallbackUserData = NULL, const FGuid* RequiredGuid = NULL );
	/**
