...
#define PLATFORM_SUPPORTS_D3D10_PLUS (_WINDOWS && !CONSOLE)
...
// Enable vector intrinsics if possible
	...
	#if ( PS3 || XBOX || IPHONE_DEVICE || ( __HAS_SSE__ && !__GNUC__ && !defined( __cplusplus_cli ) && !__INTEL_COMPILER ) )
...
// see "TonemapperType" console command help
extern INT						GTonemapperType;
...
enum EMemoryStats
{
	...
	STAT_SceneVertexShaderMemory,
	STAT_ScenePixelShaderMemory,
#endif
