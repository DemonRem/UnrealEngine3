...
enum ApexAssetType
{
  ...
  AAT_FLUID_IOS,
  AAT_IOFX,
  AAT_CLOTHING_MATERIAL,	// asset used to represent clothing material library data.
  AAT_RENDER_MESH,
...
public:
  ...
  **/
  ...
  /**
   * Gets a pointer to the Particles Module
   * @return	null if it fails, else a pointer to the NxModuleParticles. 
  **/
  virtual physx::apex::NxModuleParticles    * GetModuleParticles(void) const = 0;

  /**
   * Gets a pointer to the Emitter Module
   * @return	null if it fails, else a pointer to the NxModuleEmitter. 
  **/
  virtual physx::apex::NxModuleEmitter      * GetModuleEmitter(void) const = 0;

  /**
   * Gets a pointer to the Iofx Module
   * @return	null if it fails, else a pointer to the NxModuleIofx. 
  **/
  virtual physx::apex::NxModuleIofx         * GetModuleIofx(void) const = 0;
