 ...
 */
inline UBOOL PointsEqual(const FVector& V1,const FVector& V2, UBOOL bNoEpsilon = FALSE )
{
	const FLOAT Epsilon = bNoEpsilon ? 0.0f : THRESH_POINTS_ARE_SAME * 4.0f;	// Extra 4.0 multiplier (legacy?)
