...
VERIFY_CLASS_OFFSET_NODIE(UParticleEmitter,ParticleEmitter,InitialAllocationCount)
...
VERIFY_CLASS_OFFSET_NODIE(UParticleModuleLocationSkelVertSurface,ParticleModuleLocationSkelVertSurface,NormalCheckTolerance)
