...
public:
	...
	*/
	void SetVertexShader(const FVertexFactory* VertexFactory, const FMaterialRenderProxy* MaterialRenderProxy,const FSceneView* View,const UBOOL bAllowGlobalFog,FShader* VertexShader) const;
	...
	*/
	void SetDomainShader(const FVertexFactory* VertexFactory, const FMaterialRenderProxy* MaterialRenderProxy,const FSceneView* View,FShader* DomainShader) const;
#endif
...
private:
	...
	void Set(const FVertexFactory* VertexFactory, const FMaterialRenderProxy* MaterialRenderProxy,const FSceneView* View,const UBOOL bAllowGlobalFog,ShaderRHIParamRef Shader) const;
