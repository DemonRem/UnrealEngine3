...
public:
	struct VertexParametersType
	{
		...
		void Bind(const FShaderParameterMap& ParameterMap)
		{
			LightDirectionParameter.Bind(ParameterMap, TEXT("LightDirectionAndbDirectional"),TRUE);
		}
		...
		void Serialize(FArchive& Ar)
		{
			...
			// set parameter names for platforms that need them
			LightDirectionParameter.SetShaderParamName(TEXT("LightDirectionAndbDirectional"));
		}
	};
