...
void RenderingThreadAdvanceFrame()
{
	...
	SET_MEMORY_STAT(STAT_ScenePixelShaderMemory,0);
	SET_MEMORY_STAT(STAT_SceneVertexShaderMemory,0);
	extern TSet<void*> CurrentFrameActiveShaders;
	CurrentFrameActiveShaders.Empty();
#endif
}
