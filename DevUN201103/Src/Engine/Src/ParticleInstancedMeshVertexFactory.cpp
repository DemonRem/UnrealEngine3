...
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleInstancedMeshVertexFactory,FParticleInstancedMeshVertexFactoryShaderParameters,"MeshInstancedVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_SM2_BLENDING_SHADER_FIXES, 0);
