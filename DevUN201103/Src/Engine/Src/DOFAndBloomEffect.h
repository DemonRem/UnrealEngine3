...
public:
	...
	static void ModifyCompilationEnvironment(EShaderPlatform Platform, FShaderCompilerEnvironment& OutEnvironment)
	{
		...
		OutEnvironment.Definitions.Set(TEXT("DOF_QUALITY"), DoFQuality ? TEXT("1") : TEXT("0"));
	...
	virtual UBOOL Serialize(FArchive& Ar)
	{
		...
		Ar	<< DOFParameters << SceneTextureParameters << BloomScaleAndThresholdParameter
			<< SmallSceneColorTextureParameter << VelocityTextureParameter;
...
protected:
	...
	template <class TPShader, class TVShader> void SetupGather2x2(FViewInfo& View, TVShader &VertexShader, const FTexture2DRHIRef& SourceTexture, UBOOL bBilinearFiltered = FALSE);
	...
	*/
	void RenderGatherPass(FViewInfo& View, EGatherData DestinationData, FSceneRenderTargetIndex FilterColorIndex, INT Quality = 0, UINT DoFQuality = 0);
