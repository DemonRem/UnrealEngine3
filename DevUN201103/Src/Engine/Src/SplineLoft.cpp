...
IMPLEMENT_VERTEX_FACTORY_TYPE(FSplineMeshVertexFactory, FSplineMeshVertexFactoryShaderParameters, "LocalVertexFactory", TRUE, TRUE, TRUE, TRUE, VER_ADDED_SPLINE_MESH_OFFSET, 0);
