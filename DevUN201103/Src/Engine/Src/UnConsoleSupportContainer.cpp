...
void FConsoleSupportContainer::AddConsoleSupport(FConsoleSupport* InConsoleSupport)
{
	...
	if (appStricmp(TEXT("Xenon"), InConsoleSupport->GetConsoleName()) == 0 ||
		appStricmp(TEXT("PS3"), InConsoleSupport->GetConsoleName()) == 0 ||
		appStricmp(TEXT("IPhone"), InConsoleSupport->GetConsoleName()) == 0 ||
		appStricmp(TEXT("NGP"), InConsoleSupport->GetConsoleName()) == 0)
	{
