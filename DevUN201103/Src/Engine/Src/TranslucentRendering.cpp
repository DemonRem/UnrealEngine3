	...
	) const
{
	...
	const TArray<FSortedPrim,SceneRenderingAllocator>* PhaseSortedPrimitivesPtr = &SortedPrims;
...
*/
void FTranslucentPrimSet::AddScenePrimitive(FPrimitiveSceneInfo* PrimitiveSceneInfo,const FViewInfo& ViewInfo, UBOOL bUsesSceneColor, UBOOL bNeedsDepthPrepass, UBOOL bNeedsDepthPostpass, UBOOL bUseSeparateTranslucency)
{
	FLOAT SortKey=0.f;
