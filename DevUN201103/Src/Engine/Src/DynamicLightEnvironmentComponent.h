...
enum EDLEStats
{
	STAT_LightVisibilityTime = STAT_DLEFirstStat,
	...
	STAT_AttachLightEnvironmentTime,
...
public:
	...
	UPointLightComponent* CreateRepresentativeShadowLight(const FLinearColor& Intensity);
