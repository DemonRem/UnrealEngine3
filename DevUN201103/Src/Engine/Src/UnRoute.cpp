...
/************************************************************************
   A* functions follow
 ************************************************************************/
static ANavigationPoint* PopBestNode(ANavigationPoint*& OpenList)
{
...
static UBOOL InsertSorted(ANavigationPoint* NodeForInsertion, ANavigationPoint*& OpenList)
{
...
static UBOOL AddToOpen(ANavigationPoint*& OpenList, ANavigationPoint* NodeToAdd, ANavigationPoint* GoalNode, INT EdgeCost, UReachSpec* EdgeSpec, APawn* Pawn)
{
...
static UBOOL AddNodeToOpen( ANavigationPoint*& OpenList, ANavigationPoint* NodeToAdd, INT EdgeCost, INT HeuristicCost, UReachSpec* EdgeSpec, APawn* Pawn )
{
	ANavigationPoint* Predecessor = EdgeSpec->Start;
	NodeToAdd->visitedWeight = EdgeCost + Predecessor->visitedWeight;
...
static void RemoveNodeFromOpen(ANavigationPoint* NodeToRemove, ANavigationPoint*& OpenList)
{
