...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLocalVertexFactory,FLocalVertexFactoryShaderParameters,"LocalVertexFactory",TRUE,TRUE,TRUE,TRUE, VER_VERTEX_FACTORY_LOCALTOWORLD_FLIP,0);
