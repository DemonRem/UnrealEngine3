...
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleBeamTrailVertexFactory,FParticleBeamTrailVertexFactoryShaderParameters,"ParticleBeamTrailVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_BEAM_TRAIL_DYNAMIC_PARAMETER,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleBeamTrailDynamicParameterVertexFactory,FParticleBeamTrailVertexFactoryShaderParameters,"ParticleBeamTrailVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_BEAM_TRAIL_DYNAMIC_PARAMETER,0);
