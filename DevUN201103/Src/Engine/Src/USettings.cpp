 ...
 */
UBOOL FSettingsData::operator==(const FLOAT Other) const
{
	if (Type == SDT_Float)
	{
		return Other == *(FLOAT*)&Value1 ? TRUE : FALSE;
	}
	return FALSE;
}
UBOOL FSettingsData::operator!=(const FLOAT Other) const
 ...
 * @return TRUE if they are equal (type and value), FALSE otherwise
 */
UBOOL FSettingsData::operator==(const INT Other) const
{
	if (Type == SDT_Int32)
	{
		return Other == Value1 ? TRUE : FALSE;
	}
	return FALSE;
}
UBOOL FSettingsData::operator!=(const INT Other) const
 ...
 * @return TRUE if they are equal (type and value), FALSE otherwise
 */
UBOOL FSettingsData::operator==(const DOUBLE Other) const
{
	if (Type == SDT_Double)
	{
		DOUBLE Val;
		GetData(Val);
		return Other == Val ? TRUE : FALSE;
	}
	return FALSE;
}
UBOOL FSettingsData::operator!=(const DOUBLE Other) const
 ...
 * @return TRUE if they are equal (type and value), FALSE otherwise
 */
UBOOL FSettingsData::operator==(const QWORD Other) const
{
	if (Type == SDT_Int64)
	{
		QWORD Val;
 ...
 * @return TRUE if they are equal (type and value), FALSE otherwise
 */
UBOOL FSettingsData::operator==(const FString& Other) const
{
	if (Type == SDT_String && Value2)
	{
		return appStrcmp((const TCHAR*)Value2,*Other) == 0 ? TRUE : FALSE;
	}
	return FALSE;
}
UBOOL FSettingsData::operator!=(const FString& Other) const
 ...
 * @return TRUE if they are equal (type and value), FALSE otherwise
 */
UBOOL FSettingsData::operator==(const TCHAR* Other) const
{
	if (Type == SDT_String && Value2 && Other)
	{
		return appStrcmp((const TCHAR*)Value2,Other) == 0 ? TRUE : FALSE;
	}
	return FALSE;
