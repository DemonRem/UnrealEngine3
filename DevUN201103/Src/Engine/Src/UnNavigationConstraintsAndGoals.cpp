 ...
 */
UBOOL UNavMeshPathConstraint::EvaluatePath( FNavMeshEdgeBase* Edge, FNavMeshPolyBase* SrcPoly, FNavMeshPolyBase* DestPoly, const FNavMeshPathParams& PathParams, INT& out_PathCost, INT& out_HeuristicCost, const FVector& EdgePoint )
{
 ...
 * @return - TRUE if this edge is a valid successor candidate and should be added to the open list, FALSE if it should be thrown out
 */
UBOOL UNavMeshPath_Toward::EvaluatePath( FNavMeshEdgeBase* Edge, FNavMeshPolyBase* SrcPoly, FNavMeshPolyBase* DestPoly, const FNavMeshPathParams& PathParams, INT& out_PathCost, INT& out_HeuristicCost, const FVector& EdgePoint )
{	
	INT AddedCost = 0;
	if( GoalActor != NULL )
	{
 ...
 * @return - TRUE if this edge is a valid successor candidate and should be added to the open list, FALSE if it should be thrown out
 */
UBOOL UNavMeshPath_AlongLine::EvaluatePath( FNavMeshEdgeBase* Edge, FNavMeshPolyBase* SrcPoly, FNavMeshPolyBase* DestPoly, const FNavMeshPathParams& PathParams, INT& out_PathCost, INT& out_HeuristicCost, const FVector& EdgePoint )
{
 ...
 * @return - TRUE if this edge is a valid successor candidate and should be added to the open list, FALSE if it should be thrown out
 */
UBOOL UNavMeshPath_WithinTraversalDist::EvaluatePath( FNavMeshEdgeBase* Edge, FNavMeshPolyBase* SrcPoly, FNavMeshPolyBase* DestPoly, const FNavMeshPathParams& PathParams, INT& out_PathCost, INT& out_HeuristicCost, const FVector& EdgePoint )
{
	if( out_PathCost + Edge->VisitedPathWeight > MaxTraversalDist)
	{
...
UBOOL UNavMeshPath_WithinDistanceEnvelope::EvaluatePath( FNavMeshEdgeBase* Edge, FNavMeshPolyBase* SrcPoly, FNavMeshPolyBase* DestPoly, const FNavMeshPathParams& PathParams, INT& out_PathCost, INT& out_HeuristicCost, const FVector& EdgePoint )
{
...
*/                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
UBOOL UNavMeshPath_MinDistBetweenSpecsOfType::IsWithinMinDistOfEdgeInPath(FNavMeshEdgeBase* Edge)
{
	INT Distance = 0;
	FNavMeshEdgeBase* CurrentEdge = Edge;
...
UBOOL UNavMeshPath_MinDistBetweenSpecsOfType::EvaluatePath( FNavMeshEdgeBase* Edge, FNavMeshPolyBase* SrcPoly, FNavMeshPolyBase* DestPoly, const FNavMeshPathParams& PathParams, INT& out_PathCost, INT& out_HeuristicCost, const FVector& EdgePoint )
{
	if( Edge->GetEdgeType() == EdgeType )
	{
		...
		if((!InitLocation.IsNearlyZero() && (InitLocation - Edge->GetEdgeCenter()).SizeSquared() < MinDistBetweenEdgeTypes * MinDistBetweenEdgeTypes) ||
			IsWithinMinDistOfEdgeInPath(Edge))
		{
			out_PathCost += 10000;
		}
	}
