	...
	) const
{
	...
	if (Light)
	{
		...
		SetVertexShaderValue(VertexShader->GetVertexShader(), VertexShaderParameters->LightDirectionParameter, FVector4(LightVector, 1.0f));
	...
	else
	{
		...
		SetVertexShaderValue(VertexShader->GetVertexShader(), VertexShaderParameters->LightDirectionParameter, FVector4(0.0f, 0.0f, 1.0f, 1.0f));
