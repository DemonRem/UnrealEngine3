...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLensFlareVertexFactory,FLensFlareVertexFactoryShaderParameters,"LensFlareVertexFactory",TRUE,FALSE,FALSE,FALSE, VER_ADDDED_OCCLUSION_PERCENTAGE_EXPRESSION,0);
