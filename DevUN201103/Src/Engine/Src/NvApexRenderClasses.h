...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLocalVertexFactoryApex, FLocalVertexFactoryShaderParameters, "LocalVertexFactory", TRUE, TRUE, TRUE, TRUE, VER_DEPRECATED_EDITOR_POSITION, 0);
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FGPUSkinVertexFactoryApexDestructible, FGPUSkinVertexFactoryShaderParametersApexDestructible, "ApexGpuSkinVertexFactory_1Bone", TRUE, FALSE, TRUE, FALSE, VER_MOTIONBLURSKINNING, 0);
...
IMPLEMENT_VERTEX_FACTORY_TYPE(FGPUSkinVertexFactoryApexClothing, FGPUSkinVertexFactoryShaderParametersApexClothing, "ApexGpuSkinVertexFactory", TRUE, FALSE, TRUE, FALSE, VER_REMOVE_MAXBONEINFLUENCE, 0);
