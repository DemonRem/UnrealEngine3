...
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleSubUVVertexFactory,FParticleVertexFactoryShaderParameters,"ParticleSpriteVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_SPRITE_SUBUV_VFETCH_SUPPORT,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleSubUVDynamicParameterVertexFactory,FParticleVertexFactoryShaderParameters,"ParticleSpriteVertexFactory",TRUE,FALSE,TRUE,FALSE, VER_SPRITE_SUBUV_VFETCH_SUPPORT,0);
