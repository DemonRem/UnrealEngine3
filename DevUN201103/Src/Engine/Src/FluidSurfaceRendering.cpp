...
IMPLEMENT_VERTEX_FACTORY_TYPE(FFluidVertexFactory,FFluidVertexFactoryShaderParameters,"FluidVertexFactory",TRUE,TRUE,TRUE,FALSE,VER_VERTEX_FACTORY_LOCALTOWORLD_FLIP,0);
IMPLEMENT_VERTEX_FACTORY_TYPE(FFluidTessellationVertexFactory,FFluidVertexFactoryShaderParameters,"FluidVertexFactory",TRUE,TRUE,TRUE,FALSE,VER_VERTEX_FACTORY_LOCALTOWORLD_FLIP,0);
...
//				SetTextureParameter( NULL, HeightmapParameter, TStaticSamplerState<SF_Bilinear,AM_Clamp,AM_Clamp,AM_Clamp>::GetRHI(), NULL );
	...
	virtual EMemoryStats	GetMemoryStatType( ) const		{ return STAT_StaticMeshVertexMemory; }
