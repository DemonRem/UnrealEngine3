 ...
 */
void WxMaterialEditorBase::DrawMaterialInfoStrings(FCanvas* Canvas, const UMaterial* Material, const FMaterialResource* MaterialResource, INT &DrawPositionY)
{
...
{
	UMaterialInterface* SyncMI = GetSyncObject();
