...
void WxTexturePropertiesFrame::Draw(FViewport* Viewport,FCanvas* Canvas)
{
	...
	if (RenderInfo != NULL && RenderInfo->Renderer != NULL)
	{
		...
		RenderInfo->Renderer->Draw(TextureToRender,TPT_Plane, PreviewPaddingX, PreviewPaddingY, Width, Height,
			Viewport,Canvas,TBT_None, FColor(0, 0, 0), FColor(0, 0, 0));
...
void WxTexturePropertiesFrame::UpdateQuickInfoWindows()
{
	...
	const wxString& TextureLODBiasPS3String =  wxString(*FString::Printf( LocalizeSecure(LocalizeUnrealEd("TextureQuickInfoPS3LODBias"), LODBias360) ));
