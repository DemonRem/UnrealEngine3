...
WxMainContextCoverSlotMenu::WxMainContextCoverSlotMenu(class ACoverLink *Link, FCoverSlot &Slot)
{
	...
	// Some menu items are only available for clicking if the link is set to "manual"
	Enable( IDM_CoverEditMenu_ToggleLeanLeft, !Link->bAutoAdjust );
	Enable( IDM_CoverEditMenu_ToggleLeanRight, !Link->bAutoAdjust );
