...
FString GetPlayerNameFromIndex(INT PlayerIndex)
{
	...
	{
		const FPlayerInformationNew& PlayerInfo = GGameStatsFileReader->GetPlayerMetaData(PlayerIndex);
...
FString GetWeaponNameFromIndex(INT WeaponIndex)
{
	...
	{													
		...
		return WeaponData.WeaponClassName; 
	}
	else
	{
		return TEXT("UNKNOWN");
...
FString GetProjectileNameFromIndex(INT ProjectileIndex)
{
	...
	{													
		...
		return ProjectileData.ProjectileClassName; 
	}
	else
	{
		return TEXT("UNKNOWN");
...
FString GetDamageNameFromIndex(INT DamageIndex)
{
	...
	{													
		...
		return DamageData.DamageClassName; 
	}
	else
	{
		return TEXT("UNKNOWN");
 ...
 */
void UGameStatsDatabase::GetPlayersListBySessionID(const FString& SessionId, TArray<struct FPlayerInformationNew>& OutPlayerList)
{
	TArray<FPlayerInformationNew>* PlayerList = PlayerListBySessionID.Find(SessionId);
	if (PlayerList)
	{
