...
void WxVisualizerTab::OnAvailableVisualizerChoiceSelected( wxCommandEvent& In )
{
	...
	if (NewVis != NULL)
	{
		...
		for (INT SessionIter = 0; SessionIter < SelectedSessions.Num(); SessionIter++)
		{
			...
			TArray<FPlayerInformationNew> PlayerList;
...
*/
void WxVisualizerTab::UpdatePlayerListControl(const FString& SessionID, TArray<FPlayerInformationNew>& PlayerList)
{
	...
	{
		const FPlayerInformationNew& Player = PlayerList(PlayerIdx);
