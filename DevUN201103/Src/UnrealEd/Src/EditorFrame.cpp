...
public:
	WxRotationGridMenu()
	{
		...
		AppendCheckItem( IDM_ROTATION_GRID_512, *LocalizeUnrealEd("RotationSnapMenu_2_8125_Degrees"), *RotationGridAngleToolTip );
		AppendCheckItem( IDM_ROTATION_GRID_1024, *LocalizeUnrealEd("RotationSnapMenu_5_625_Degrees"), *RotationGridAngleToolTip );
		AppendCheckItem( IDM_ROTATION_GRID_2048, *LocalizeUnrealEd("RotationSnapMenu_11_25_Degrees"), *RotationGridAngleToolTip );
		AppendCheckItem( IDM_ROTATION_GRID_4096, *LocalizeUnrealEd("RotationSnapMenu_22_5_Degrees"), *RotationGridAngleToolTip );
		AppendCheckItem( IDM_ROTATION_GRID_8192, *LocalizeUnrealEd("RotationSnapMenu_45_Degrees"), *RotationGridAngleToolTip );
		AppendCheckItem( IDM_ROTATION_GRID_16384, *LocalizeUnrealEd("RotationSnapMenu_90_Degrees"), *RotationGridAngleToolTip );
	}
};
...
public:
	...
	WxPreferencesMenu()
	{
		...
		AppendCheckItem( IDM_MainMenu_ViewportCameraToUpdateFromPIV, *LocalizeUnrealEd( "MainMenu_ViewportCameraToUpdateFromPIV" ), *LocalizeUnrealEd( "IDM_MainMenu_ViewportCameraToUpdateFromPIV_ToolTip" ) );
...
{
	// Construct the proper exe to swtich to.
...
#endif
	// If we are in debug mode, launch the debug process
#if _DEBUG
	PendingProjectExe = appRootDir()*FString(TEXT("Binaries"))*PlatformConfig*FString(TEXT("Debug-"))+ProjectName+FString(TEXT("Game.exe"));
#elif FINAL_RELEASE
	FString ExeName;
	// Mobile has a special exe name.
	if( ProjectName == TEXT("Mobile"))
	{
		ExeName = TEXT("UDKMobile")
	}
	else
	{
		ExeName = ProjectName;
	}
	PendingProjectExe = appRootDir()*FString(TEXT("Binaries"))*PlatformConfig*ExeName+FString(TEXT(".exe")) ;
#else
	PendingProjectExe = appRootDir()*FString(TEXT("Binaries"))*PlatformConfig*ProjectName+FString(TEXT("Game.exe"));
#endif
}
