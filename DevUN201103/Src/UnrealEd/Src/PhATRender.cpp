...
void FPhATViewportClient::Draw(FViewport* Viewport, FCanvas* Canvas)
{
	...
	FString StatusString = FString::Printf( LocalizeSecure(LocalizeUnrealEd("BodiesConstraints_F"), AssetEditor->PhysicsAsset->BodySetup.Num(), AssetEditor->PhysicsAsset->ConstraintSetup.Num()) );
