...
UBOOL				WxSoundCueEditor::bImportedChirpClasses = false;
TArray<FString>		WxSoundCueEditor::ChirpSoundClasses;
 ...
 */
UBOOL WxSoundCueEditor::IsEligibleForRadioChirp( USoundCue* ChirpCandidate )
{
