 ...
 */
WxBitmapStateButton::WxBitmapStateButton( wxWindow* InParent, wxWindow* InMsgTarget, wxWindowID InID, const wxPoint& InPos/*=wxDefaultPosition*/, const wxSize& InSize/*=wxDefaultSize*/, UBOOL bCycleOnLeftMouseDown/*=TRUE*/)
	: WxBitmapButton( InParent, InID, WxBitmap(8,8), InPos, InSize )
{
	if ( bCycleOnLeftMouseDown )
	{
...
WxBitmapCheckButton::WxBitmapCheckButton( wxWindow* InParent, wxWindow* InMsgTarget, wxWindowID InID, wxBitmap* InBitmapOff, wxBitmap* InBitmapOn, const wxPoint& InPos, const wxSize& InSize )
	: WxBitmapStateButton( InParent, InMsgTarget, InID, InPos, InSize )
{
