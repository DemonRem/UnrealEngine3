...
void WxDlgLightingResults::Initialize()
{
	...
	DlgPosSizeName = TEXT("DlgLightingResults");
...
void WxDlgLightingResults::SetupErrorWarningListColumns()
{
	if (ErrorWarningList)
	{
		// Columns are, from left to right: Level, Object, Message.
		ErrorWarningList->InsertColumn( 0, *LocalizeUnrealEd("Message"), wxLIST_FORMAT_LEFT, 700 );
		ErrorWarningList->InsertColumn( 0, *LocalizeUnrealEd("Object"), wxLIST_FORMAT_LEFT, 150 );
		ErrorWarningList->InsertColumn( 0, *LocalizeUnrealEd("Level/Package"), wxLIST_FORMAT_LEFT, 150 );
	}
}
