 ...
 */
class WxCustomPropertyItem_MaterialInstanceConstantParameter : public WxCustomPropertyItem_ConditionalItem
{
public:
...
class WxPropertyWindow_MaterialInstanceConstantParameters : public WxItemPropertyControl
{
public:
