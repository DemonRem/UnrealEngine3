...
struct HInterpEdTrackGraphPropBtn : public HHitProxy
{
	...
	HInterpEdTrackGraphPropBtn(class UInterpGroup* InGroup, UInterpTrack* InTrack ) :
		HHitProxy(HPP_UI),
		Group(InGroup),
		Track(InTrack)
	{}
...
public:
	 ...
	 */
	void DrawSubTrackGroup( FCanvas* Canvas, UInterpTrack* Track, const FSubTrackGroup& InGroup, INT GroupIndex, const FInterpTrackLabelDrawParams& LabelDrawParams );
...
public:
	 ...
	 */
	void UpdateLevelViewport(AActor* InActor, FEditorLevelViewportClient* InViewportClient, const FLOAT InFadeAmount, const FVector& InColorScale, const UBOOL bInEnableColorScaling);

	void SyncCurveEdView();
	void AddTrackToCurveEd(class UInterpGroup* InGroup, class UInterpTrack* InTrack );
