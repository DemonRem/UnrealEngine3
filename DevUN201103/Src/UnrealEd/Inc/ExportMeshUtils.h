...
namespace ExportMeshUtils
{
	 ...
	 */
	UBOOL ExportAllLightmapModels (TArray<UStaticMesh*>& AllMeshes, const FString& Directory);
	 ...
	 */
	UBOOL ImportAllLightmapModels (TArray<UStaticMesh*>& AllMeshes, const FString& Directory);
	 ...
	 * @return If any errors occured during import
	 */
	UBOOL ImportSingleLightmapModelFBX(UStaticMesh* CurrentStaticMesh, const TArray<BYTE>& Data, const INT LODIndex );
