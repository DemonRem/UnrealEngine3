...
protected:
	 ...
	 */
	static void SanitizePropertyDisplayName( FString& InOutPropertyDisplayName, const UBOOL bIsBoolProperty );
...
public:
	 ...
	 */
	void SetExpanded   (const UBOOL bInExpanded, const UBOOL bInRecurse);
	/**
	 * 	 Mark node with proper name as needing to be expanded/collapsed (and WILL refresh the windows system)
	 */
	void SetExpandedItem(const FString& PropertyName, INT ArrayIndex, const UBOOL bInExpanded);
	 ...
	 */
	FPropertyNode* GetChildNode (const INT ChildIndex)
	{
...
protected:
	 ...
	 */
	void SetExpandedInternal   (const UBOOL bInExpanded, const UBOOL bInRecurse);
	/**
	 ...
	 */
	void SetExpandedItemInternal (const FString& InPropertyName, INT InArrayIndex, const UBOOL bInExpanded);
