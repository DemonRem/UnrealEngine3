...
public:
	...
	/**
	 * Imports a COLLADA transform curve into a movement subtrack
	 */
	void ImportMoveSubTrack(FCDAnimationMultiCurve* ColladaCurve, INT ColladaDimension, FInterpCurveFloat& Curve, FCDConversionFunctor* Conversion = NULL);
