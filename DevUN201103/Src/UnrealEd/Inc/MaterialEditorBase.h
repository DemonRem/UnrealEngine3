...
public:
	 ...
	 */
	void DrawMaterialInfoStrings(FCanvas* Canvas, const UMaterial* Material, const FMaterialResource* MaterialResource, INT &DrawPositionY);
...
protected:
	...
	virtual UMaterialInterface* GetSyncObject() { return NULL; };
