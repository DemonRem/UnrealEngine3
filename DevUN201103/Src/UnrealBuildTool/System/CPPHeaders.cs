...
namespace UnrealBuildTool
{
	partial class CPPEnvironment
	{
		...
		public List<string> GetDirectIncludeDependencies( FileItem CPPFile )
		{
			...
			// iPhone needs special handling - it needs the real Unity file to have Mac paths, but we need
			// an extra file for tracking includes
			if ((TargetPlatform == CPPTargetPlatform.IPhoneDevice || TargetPlatform == CPPTargetPlatform.IPhoneSimulator) &&
