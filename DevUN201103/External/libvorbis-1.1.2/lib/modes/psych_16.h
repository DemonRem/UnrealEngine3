...
static double _psy_lowpass_16[5] = { 6.0, 6.5, 8.0, 30.0, 99.0 };
...
static double _noise_thresh_16[5] = { 0.3, 0.3, 0.5, 0.5, 0.5 };

static int _noise_start_16[4] = { 256, 256, 256, 9999 };
static int _noise_part_16[5] = { 8, 8, 8, 8, 8 };

static int _psy_ath_floater_16[5] = { -100, -100, -100, -100, -105, };
static int _psy_ath_abs_16[5] = { -130, -130, -130, -130, -140, };
