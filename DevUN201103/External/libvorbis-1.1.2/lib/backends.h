...
/* this is exposed up here because we need it for static modes. Lookups for each backend aren't exposed because there's no reason to do so */
...
typedef struct
{
	...
	int						( *forward )( oggpack_buffer*, struct vorbis_block*, vorbis_look_residue*, float**, float**, int*, int, long** );
