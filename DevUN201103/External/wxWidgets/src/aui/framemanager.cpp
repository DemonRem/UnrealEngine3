...
// Modified by:
// Created:     2005-05-17
// RCS-ID:      $Id: framemanager.cpp 55206 2008-08-23 16:19:16Z VZ $
...
bool wxAuiManager::LoadPerspective(const wxString& layout, bool update)
{
    ...
    while (1)
    {
		...
		//Saving off caption.  While the layout and name are going to be the same, this window was constructed with a custom caption that should remain
		wxString OldCaption = p.caption;
        p.SafeSet(pane);
		p.caption = OldCaption;
    }
