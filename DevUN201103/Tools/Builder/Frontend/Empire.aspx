<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Empire.aspx.cs" Inherits="Empire" Debug="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Trigger an Empire Xenon Build from the Chair branch</title>
</head>
<body>
...
<center>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="XX-Large"
            Height="56px" Text="Epic Build System - Trigger Build from Chair branch" Width="640px" ForeColor="Blue"></asp:Label><br /><br />
        ...
        <br />
            ...
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="201000" />
            </SelectParameters>
            </asp:SqlDataSource>
...
<asp:QueryStringParameter Name="DisplayDetailID" Type="Int32" DefaultValue="200000" />
</SelectParameters>
 </asp:SqlDataSource>
