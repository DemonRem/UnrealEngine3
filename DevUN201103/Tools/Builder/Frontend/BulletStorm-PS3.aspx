<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bulletstorm-PS3.aspx.cs" Inherits="Bulletstorm" Debug="true" %>
...
<center>
    ...
    <div>
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="211000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="211999" />
            </SelectParameters>
            </asp:SqlDataSource>
