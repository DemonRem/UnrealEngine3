		...
		static ConfigManager()
		{
			...
			PlatformConfigs AllPlatformConfigs = new PlatformConfigs
			{
				LaunchConfigs = new ConfigList
				{
					...
					{ Profile.Configuration.ShippingDebug_32,    true },
					{ Profile.Configuration.ShippingDebug_64,    true },
				},
			...
			PlatformToConfigMap.Add(ConsoleInterface.PlatformType.PCConsole, AllPlatformConfigs);
			PlatformToConfigMap.Add(ConsoleInterface.PlatformType.PCServer, AllPlatformConfigs);
			...
			PlatformConfigs Consoles = new PlatformConfigs
			{
				LaunchConfigs = new ConfigList
				{
					// Config                                    UDK
			...
			PlatformToConfigMap.Add(ConsoleInterface.PlatformType.Xbox360, Consoles);
			PlatformToConfigMap.Add(ConsoleInterface.PlatformType.PS3, Consoles);

			PlatformToConfigMap.Add(ConsoleInterface.PlatformType.PC, new PlatformConfigs
			{
				LaunchConfigs = new ConfigList
				{
					// Config                                    UDK
