...
namespace ConsoleInterface
{
	...
	private:
		...
		void ProcessFileGroups(List<TOCInfo^>^ TOC, array<FileGroup^>^ FileGroups, TOCSettings^ BuildSettings, array<Tag^>^ SyncTags, List<String^>^ NotPlatforms, List<String^>^ NotLanguages, List<String^>^ NotGames, String^ Language);
		void TocAddFile(List<TOCInfo^>^ TOC, TOCSettings^ BuildSettings, FileInfo^ SrcFile, String^ RootFolder, bool bIsForSync, bool bIsForTOC);
		int TocFindStartSector(String^ Directory, String^ Filename, TOCSettings^ BuildSettings);
		void TocIncludeFiles(List<TOCInfo^>^ TOC, TOCSettings^ BuildSettings, String^ SourceFolder, String^ SourcePattern, FileSet^ CurSet, FileGroup^ Group, List<String^>^ NotPlatforms, List<String^>^ NotLanguages, List<String^>^ NotGames, String^ Language);
