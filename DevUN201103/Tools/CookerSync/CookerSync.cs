	...
	partial class CookerSyncApp
	{
		...
		static int Main(string[] Args)
		{
			...
			if( bWasSuccessful && PlatformToSyncName != null )
			{
				...
				{
					if( PlatformToSyncName.ToUpper() == "PS3" )
					{
						PlatSettings.bUppercasePathNames = true;
					}
				}
			}
			else
			...
			if(bWasSuccessful)
			{
				...
				try
				{
					...
					using (XmlReader Reader = XmlReader.Create( string.Format( "..\\{0}\\Build\\CookerSync_game.xml", PlatSettings.GameName ) ) )
					{
