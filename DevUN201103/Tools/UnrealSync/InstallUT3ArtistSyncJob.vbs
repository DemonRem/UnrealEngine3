...
Sub CreateProjectJob()
	...
	strKeyPath = strKeyPath & "\" & "UT3"

	batchFilePath = clientRoot & "\UnrealEngine3\UTGame\Build\envy-artist-sync.bat"
	Randomize()
	...
	oReg.SetStringValue HKEY_CURRENT_USER,strKeyPath,"GameProcessName","UTGame"
