...
{
public:
	// these three methods must be implemented in the derived class platform specific way
	virtual NPBool		init( NPWindow* aWindow ) = 0;
	virtual void		shut( void ) = 0;
	virtual NPBool		isInitialized( void ) = 0;

	// implement all or part of those methods in the derived class as needed
