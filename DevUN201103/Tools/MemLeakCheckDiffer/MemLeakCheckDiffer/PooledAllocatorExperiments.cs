    ...
    class PooledAllocatorExperiments
    {
        ...
        public static void Run(List<MemLeakFile> Files)
        {
            ...
            int[] MichaelCTNormal =
            {
		        ...
		        5456,	5952,	6544,	7280,	8192,	9360,	10912,	13104,
		        16384
            };
            MemStatsReportSection.MemPoolSet CTNormalSetup = new MemStatsReportSection.MemPoolSet(65536, MichaelCTNormal);

            int[] MichaelVirtualSizes =
            {
		        8,		16,		32,		48,		64,		80,		96,		112,
            ...
            MemStatsReportSection.MemPoolSet FinalVirtualSetup = new MemStatsReportSection.MemPoolSet(65536, MichaelVirtualSizes);
            ...
            ExperimentList.Add(new SlackReductionExperiment("SmallBlock", SmallerBlockSetup.Clone(), SmallerBlockSetup.Clone(), SmallerBlockSetup.Clone()));
            ExperimentList.Add(new SlackReductionExperiment("Martin", MartinSetup.Clone(), MartinSetup.Clone(), MartinSetup.Clone()));
            ExperimentList.Add(new SlackReductionExperiment("MartinSmallBlock", SmallerBlockMartinSetup.Clone(), SmallerBlockMartinSetup.Clone(), SmallerBlockMartinSetup.Clone()));
            ExperimentList.Add(new SlackReductionExperiment("ReducedPhysicals", CTNormalSetup.Clone(), CTNormalSetup.Clone(), StandardSetup.Clone()));
            ExperimentList.Add(new SlackReductionExperiment("MartinAndReducedPhys", CTNormalSetup.Clone(), CTNormalSetup.Clone(), MartinSetup.Clone()));
            ExperimentList.Add(new SlackReductionExperiment("IdealPerhaps", CTNormalSetup.Clone(), CTNormalSetup.Clone(), FinalVirtualSetup.Clone()));
