...
namespace MemLeakDiffer
{
    public partial class MemDiffer : Form
    {
        ...
        void InitializeGameNameList()
        {
            ...
            string ActiveGameName = global::MemLeakDiffer.Properties.Settings.Default.GameName;
        ...
        private void GameSelectionBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string ActiveGameName = GameSelectionBox.SelectedText;
            //@TODO: How to save this, or are these settings readonly
            //global::MemLeakDiffer.Properties.Settings.Default.GameName = ActiveGameName;
        }
			...
			if (SourceFile != null)
			{
				...
				if (SourceFile.FindFirstSection<MemStatsReportSection>(out MemStartsReportSectionInst))
				{
					...
					if (IsChartEntryEnabled("HighestMemRecentlyKB", true) == true)
					{
						...
						SystemMemString += "HighestMemOccurredAgo=" + MemStartsReportSectionInst.HighestMemOccurredAgo + Delimiter;
					}
				}
			}
