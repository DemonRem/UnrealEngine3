...
[InspectableList("disabled", "visible", "liveDragging", "minimum", "maximum", "value", "snapping", "snapInterval", "offsetLeft", "offsetRight", "enableInitCallback", "soundMap", "bTriggerSoundsOnEvents")]
...
// Private Methods:
	...
	private function draw():Void {
		...
		// Reset displayFocus because thumb/track instances may have changed
		if (!_disabled) {
			track.displayFocus = thumb.displayFocus = false;
			if (_focused) {
				track.displayFocus = thumb.displayFocus = (_focused != 0);
			}
		}
